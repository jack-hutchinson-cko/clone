export const themes = {
  light: {
    colors: {
      ...
      background: '#FFFFFF',
      backgroundDark: '#f1f2f4',
      backgroundSearch: '#F1F2F4',
      ...
      btnPrimaryHover: '#3D4168',
      btnPrimaryDisabledFont: '#9EA0B4',
      btnPrimaryDisabled: '#CECFD9',
      btnSecondaryFont: '#0C1142',
      btnSecondaryBackground: '#2BD4DB',
      btnSecondaryHover: '#6BE1E6',
      ...
      codeSampleTokenComment: '#3d4168',
      codeSampleTokenPunctuation: '#B6B8C6',
      codeSampleTokenProperty: '#0C1142',
      codeSampleTokenSelector: '#6964b3',
      codeSampleTokenOperator: '#0C1142',
    ...
    shadows: {
      ...
      cardForm: [
        '0 1px 3px 0 rgba(19, 57, 94, 0.4)',
        '0 2px 5px 0 rgba(19, 57, 94, 0.4)',
        '0 2px 5px 0 rgba(19, 57, 94, 0.15)',
        '0 1px 3px 0 rgb(19 57 94 / 20%)',
      ],
      cardFormInvalid: ['0 2px 5px 0 rgba(217, 104, 48, 0.15)'],
    },
  ...
  dark: {
    colors: {
      ...
      btnPrimaryHover: '#FFFFE3',
      btnPrimaryDisabledFont: '#8688A0',
      btnPrimaryDisabled: '#55587B',
      btnSecondaryFont: '#0C1142',
      btnSecondaryBackground: '#2BD4DB',
      btnSecondaryHover: '#6BE1E6',
      btnSecondaryDisabledFont: '#9EA0B4',
      ...
      codeSampleHighlightedLine: '#6D708E',
      codeSampleLineNumber: '#0082d9',
      codeSampleTokenComment: '#8688a0',
      codeSampleTokenPunctuation: '#b6b8c6',
      codeSampleTokenProperty: '#f3c25d',
      codeSampleTokenSelector: '#8680d6',
      codeSampleTokenOperator: '#a67f59',
