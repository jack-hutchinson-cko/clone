...
<HomePageItem 
  ...
  links={[{title: 'Manage payments', href: '/dashboard/track-and-manage-payments'}, {title: 'Generate reports', href: '/dashboard/generate-reports'}, {title: 'View analytics', href: '/dashboard/analytics'}]}
  >
...
<HomePageItem 
  ...
  links={[{title: 'Manage disputes via API', href: '/risk-management/disputes/disputes-api'}, {title: 'Manage disputes via Dashboard', href: '/dashboard/manage-disputes'}, {title: 'Upload evidence', href: '/risk-management/disputes/file-uploader'}]}
  >
