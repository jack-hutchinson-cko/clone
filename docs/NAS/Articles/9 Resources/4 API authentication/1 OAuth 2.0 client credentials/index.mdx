...
Access your Dashboard then select _Menu_ > _Settings_ then choose the option _Access Keys_. Select one of the keys of the list.

<img src="/NAS/Resources/access+key+modal.png" />

Select _Generate Secret_ then _Generate_.
