...
Once you've done that, you can either use those bank account details directly in your [payout request](/bank-payouts/request-a-payout#Requestapayout-requestpayout), or use them to [create a reusable bank account payment instrument](/payments/store-payment-details/payment-instruments), which you can then use in your bank payout requests.
