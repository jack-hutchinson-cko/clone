...
- You have your `client id` and `client secret`, so you can generate access tokens with the required scopes. See our [authentication workflow](/resources/access-key-authentication) for more information.
