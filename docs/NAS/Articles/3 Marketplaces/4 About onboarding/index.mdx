...
<ContentPanel variant="heading" title="Onboard a sub-entity" imgSrc="/docs/NAS/Marketplaces/onboard-sub-entities.svg">
...
<ContentPanel variant="heading" title="Upload a file" imgSrc="/docs/NAS/Marketplaces/onboard-sub-entities.svg">
