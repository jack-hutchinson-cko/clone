...
You can also subscribe to the status [webhook notification](/workflows/webhook-event-types) to keep up to date with any asynchronous changes.
...
<ContentPanel variant="heading" title="Onboard a sub-entity" imgSrc="/NAS/Marketplaces/onboard-sub-entities.svg">

We'll walk you through the entire process for onboarding a sub-entity onto your platform.

<ButtonLinkSecondary href="/marketplaces/about-onboarding/onboard-a-sub-entity-lite">Lite account type</ButtonLinkSecondary>
<ButtonLinkSecondary href="/marketplaces/about-onboarding/onboard-a-sub-entity-full">Full account type</ButtonLinkSecondary>
...
<ButtonLinkSecondary href="/marketplaces/about-onboarding/upload-a-file">Find out more</ButtonLinkSecondary>
