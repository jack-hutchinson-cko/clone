...
* Identity documentation when [creating or updating your sub-entity.](/marketplaces/about-onboarding/onboard-a-sub-entity-full)
* Bank verification documentation when [creating a payment instrument](/marketplaces/about-payouts/make-a-payout)
...
If you received a file `id` in your response, the document was accepted. You can see this association by [retrieving the sub-entity.](/marketplaces/about-onboarding/onboard-a-sub-entity-full#Onboardasub-entity(full)-Retrieveasub-entity)
...
<ContentPanel variant="heading" title="Update a sub-entity" imgSrc="/docs/NAS/Marketplaces/onboard-sub-entities.svg">
...
<ContentPanel variant="heading" title="Make a payout" imgSrc="/docs/NAS/Marketplaces/about-making-payouts.svg">
...
<ButtonLinkSecondary href="/marketplaces/about-payouts/make-a-payout">Learn more</ButtonLinkSecondary>
