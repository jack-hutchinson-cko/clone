...
<ContentPanel variant="heading" title="Accept a payment" imgSrc="/docs/NAS/Marketplaces/accept-a-payment.svg">
...
<ContentPanel variant="heading" title="Status types" imgSrc="/docs/NAS/Marketplaces/onboard-sub-entities.svg">
