...
Our Unified Payments API enables you to process payments on behalf of a sub-entity. Follow the instructions for our [payments endpoint](/payments/accept-payments/request-a-payment). The only thing that is different is that you need to include  `marketplace.sub_entity_id`. Here you should use the sub-entity ID returned during the [onboarding process](/marketplaces/about-onboarding).
...
For more information about what these fields mean, see our [payments page](/payments/accept-payments/request-a-payment).
...
- [Response codes (if the authorization was unsuccessful)](/resources/codes/response-codes)
...
<ContentPanel variant="heading" title="About making payouts" imgSrc="/docs/NAS/Marketplaces/about-making-payouts.svg">

**`Full`** sub-entities have payout capability. Use this page to find out what you can do.

<ButtonLink href="/marketplaces/about-payouts">Learn more</ButtonLink>
</ContentPanel>

## Find out more

<ContentPanel variant="heading" title="Marketplace API" imgSrc="/docs/NAS/Marketplaces/marketplaces-api.svg">
