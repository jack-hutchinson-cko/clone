...
There are different options available to you depending on what account type you were onboarded with. If you're unsure which account type you are, please see our [account structure page](/marketplaces/account-structure) or [contact us](https://www.checkout.com/contact-us).
...
<ButtonLink href="https://docs.checkout.com/four/marketplaces/about-payouts/make-a-payout">Learn more</ButtonLink>
</ContentPanel>
