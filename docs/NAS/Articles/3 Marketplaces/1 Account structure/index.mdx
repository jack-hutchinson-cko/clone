...
<ContentPanel variant="heading" title="About onboarding sub-entities" imgSrc="/NAS/Marketplaces/onboard-sub-entities.svg">
...
<ContentPanel variant="heading" title="Onboard sub-entities" imgSrc="/NAS/Marketplaces/onboard-sub-entities.svg">
