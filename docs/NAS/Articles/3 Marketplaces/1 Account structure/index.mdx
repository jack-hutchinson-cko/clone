...
<Table>
<TableHead headers={['Resource', 'Description']} />
<TableBody>
<TableRow>
<TableCell>
...
Sub-entities are [onboarded by your Platform](/marketplaces/about-onboarding) via the Marketplace API!
...
<ContentPanel variant="heading" title="About onboarding sub-entities" imgSrc="/docs/NAS/Marketplaces/onboard-sub-entities.svg">

Find out more about onboarding and verification for your sub-entities.

<ButtonLink href="/marketplaces/about-onboarding">Learn more</ButtonLink>

</ContentPanel>
<ContentPanel variant="heading" title="Onboard sub-entities" imgSrc="/docs/NAS/Marketplaces/onboard-sub-entities.svg">

We'll **walk you through** the entire process of onboarding a sub-entity from your Platform onto our solution.

<ButtonLinkSecondary href="/marketplaces/about-onboarding/onboard-a-sub-entity-lite">Lite account</ButtonLinkSecondary>
<ButtonLinkSecondary href="/marketplaces/about-onboarding/onboard-a-sub-entity-full">Full account</ButtonLinkSecondary>
