...
You will then receive a [webhook notification](/bank-payouts/request-a-payout#Requestapayout-webhooks) indicating the status of your payout
...
Use our [testing guide](/pay-to-bank/testing#Testing-Payoutrequests) to test different payout scenarios.
