...
Generate an FX quote with the following endpoint. You can then use the unique quote `id` you get in the response to make a payout at the quoted rate. To get a detailed view of all required and optional fields, see our [API reference](https://api-reference.checkout.com/preview/crusoe).
