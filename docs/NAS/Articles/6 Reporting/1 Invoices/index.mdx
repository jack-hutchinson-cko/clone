...
If you opted for **net settlement**, [download this sample invoice](https://assets.checkout.com/docs/downloads/sample_invoice_net.pdf).

If you opted for **gross settlement**, [download this sample invoice](https://assets.checkout.com/docs/downloads/sample_invoice.pdf).

<TipBox variant="info">

If you're using Safari, hold the _Option_ key when you select download.
