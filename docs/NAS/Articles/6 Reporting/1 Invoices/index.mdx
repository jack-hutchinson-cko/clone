...
If you opted for **net settlement**, <ExternalLink href="https://assets.checkout.com/docs/downloads/sample_invoice_net.pdf" target="_blank">download this sample invoice</ExternalLink>.

If you opted for **gross settlement**, <ExternalLink href="https://assets.checkout.com/docs/downloads/sample_invoice.pdf" target="_blank">download this sample invoice</ExternalLink>.
