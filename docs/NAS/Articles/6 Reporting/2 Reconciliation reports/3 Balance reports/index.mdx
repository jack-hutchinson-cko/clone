...
[Download a sample balance report](https://assets.checkout.com/docs/downloads/sample_balance_report.csv) (.csv file). If you're using Safari, hold down the _Option_ key when you download.
