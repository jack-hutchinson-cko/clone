...
<ExternalLink href="https://assets.checkout.com/docs/downloads/sample_balance_report.csv" target="_blank">Download a sample balance report</ExternalLink>. If you're using Safari, hold down the _Option_ key when you download. (.csv file)
