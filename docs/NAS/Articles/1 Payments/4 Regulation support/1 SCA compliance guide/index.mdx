...
- [Check if SCA applies to you](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-scascope).
- See if your [business model and transactions require strong authentication](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-businessmodels).
- Make sure your integration supports [3D Secure (3DS) authentication](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-3ds).
...
Even if SCA applies to your business, some transactions fall [outside the scope of SCA](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-outofscope), or can benefit from possible [exemptions](https://docs.checkout.com/four/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-exemptions) if the customer's bank approves.
...
Some issuing banks have started soft declining payments that are not SCA-ready (in other words, not authorizing some payments without [3DS authentication](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-3ds)) in preparation for the above deadlines, so we recommend you support 3DS authentication as soon as possible to avoid any potential issues.
...
Use our [3D Secure API integration](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-3dssolution) to implement 3DS authentication on your card payments and request SCA exemptions. It supports both 3DS1 and 3DS2.
...
- Many common European payment methods, like [Bancontact](/payments/payment-methods/cards/bancontact), [iDEAL](/payments/payment-methods/bank-transfers/ideal), and [Multibanco](/payments/payment-methods/cash-and-atm-payment/multibanco), should also follow the SCA requirements.
...
Yes, unless [exemptions](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-exemptions) apply.
...
`"3ds.enabled": true or "3ds.exemption"``"source.stored": true`
...
No. These qualify as [merchant-initiated transactions (MITs)](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-mits) which fall outside the scope of SCA.	
...
No. These qualify as [MITs](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-mits), which are out of scope.	
...
No. [MOTO payments](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-moto) are out of scope.	
