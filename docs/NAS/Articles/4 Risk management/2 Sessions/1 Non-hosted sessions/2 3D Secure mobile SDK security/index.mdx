...
We regularly provide updates to the 3D Secure SDK and review our security guidance. For full details of the changes in each SDK update, see the release notes. To be notified of changes across Checkout.com’s products, [subscribe to our change log](/changelog).
