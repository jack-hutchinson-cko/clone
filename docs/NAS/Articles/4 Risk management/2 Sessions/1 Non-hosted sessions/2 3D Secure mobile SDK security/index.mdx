...
Communication with the [Checkout.com](https://www.checkout.com/) 3DS Server is secured using the latest versions of Transport Layer Security (TLS). The device data passed to the [Checkout.com](https://www.checkout.com/) 3DS Server and forwarded to the card scheme’s Directory Server (DS) is transferred in an encrypted format.
...
Do not disable certificate transparency checks by using a wildcard domain in your iOS app’s plist file. This interferes with the SDK operations and may result in a failure. For more information, see the Apple documentation on [NSAppTransportSecurity](https://developer.apple.com/documentation/bundleresources/information_property_list/nsapptransportsecurity) and [NSExceptionDomains](https://developer.apple.com/documentation/bundleresources/information_property_list/nsapptransportsecurity/nsexceptiondomains).
...
We regularly provide updates to the 3D Secure SDK and review our security guidance. For full details of the changes in each SDK update, see the release notes. To be notified of changes across [Checkout.com](https://www.checkout.com/)’s products, [subscribe to our change log](/changelog).
