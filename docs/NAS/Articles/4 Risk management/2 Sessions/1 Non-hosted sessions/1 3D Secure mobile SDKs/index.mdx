...
To provide a consistent experience across different devices and schemes, there are standard templates and rules that the 3DS challenge screens adhere to. However, there is some leeway around styling. Our SDKs give you [control over the display of the native challenges in your app](/risk-management/sessions/non-hosted-sessions/3d-secure-mobile-sdks#id-3DSecuremobileSDKs-customization), while ensuring that the rules are followed.
...
1. [Integrate](/risk-management/sessions/non-hosted-sessions/3d-secure-mobile-sdks#id-3DSecuremobileSDKs-integrate) the 3DS SDK.
2. [Initialize](/risk-management/sessions/non-hosted-sessions/3d-secure-mobile-sdks#id-3DSecuremobileSDKs-initialize) the SDK with your preferred user interface options.
3. Request the SDK to [authenticate the cardholder](/risk-management/sessions/non-hosted-sessions/3d-secure-mobile-sdks#id-3DSecuremobileSDKs-authentication).
4. [Consume the result](/risk-management/sessions/non-hosted-sessions/3d-secure-mobile-sdks#id-3DSecuremobileSDKs-result) you get from the SDK to continue your payment flow.
...
#### Authentication Parameters properties
...
To apply your own style, simply include a UI Customization object when you [initialise the SDK](/risk-management/sessions/non-hosted-sessions/3d-secure-mobile-sdks#id-3DSecuremobileSDKs-initialize). We've included some code examples below to show you how you might build the object.

<tabs>
<tab title="iOS">

<Box horizontal="sm">
<Accordion title="Customization example"> 
