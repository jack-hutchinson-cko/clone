...
To generate a disputes report, and view any you've previously created, log in to the Dashboard and go to _Reports. Click New report_ to create a new disputes report.
