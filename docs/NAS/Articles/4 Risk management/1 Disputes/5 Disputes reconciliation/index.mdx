...
**Dashboard**. Log in to the Dashboard and go to Settlements. Select a settlement from the list to open the settlement details page. In the Transactions breakdown section, select _Download CSV_ to download a report of financial actions by payout ID. This will give you a breakdown of transactions for that particular settlement. 
