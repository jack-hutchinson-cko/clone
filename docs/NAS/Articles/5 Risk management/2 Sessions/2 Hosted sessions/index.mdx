...
[Redirect the customer](/four/risk-management/sessions/hosted-sessions#Hostedsessions-redirectcustomer)
...
To increase the likelihood of frictionless authentication, [add additional data fields](/risk-management/sessions/hosted-sessions#Hostedsessions-additionalauthenticationdata) when requesting a session.
...
You should receive a `202 - Accepted` response with a `_links.redirect` link. For the full API specification, see the <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/" target="_blank">API reference</ExternalLink>.
...
[See below for all possible statuses and their meanings](/risk-management/sessions/hosted-sessions#Hostedsessions-statuses).
...
[See below for all possible actions and their meanings.](/risk-management/sessions/hosted-sessions#Hostedsessions-actions).
