...
[Redirect the customer](https://docs.checkout.com/four/risk-management/sessions/hosted-sessions#Hostedsessions-redirectcustomer)
...
You should receive a `202 - Accepted` response with a `_links.redirect` link. For the full API specification, see the [API reference](https://api-reference.checkout.com/preview/crusoe/).
