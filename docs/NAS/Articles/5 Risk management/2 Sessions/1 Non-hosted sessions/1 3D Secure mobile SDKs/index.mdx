...
1. [Initialize](/risk-management/sessions/non-hosted-sessions/3-d-secure-mobile-sd-ks#id-3DSecuremobileSDKs-initialize) the SDK with your preferred user interface options.
...
Initialize the SDK, setting the environment (production or sandbox), the locale, and your preferred [challenge user interface options](/risk-management/sessions/non-hosted-sessions/3-d-secure-mobile-sd-ks#id-3DSecuremobileSDKs-customization).
...
The [customizations for the challenge user interface](/risk-management/sessions/non-hosted-sessions/3-d-secure-mobile-sd-ks#id-3DSecuremobileSDKs-customization).
...
To apply your own style, simply include a UI Customization object when you [initialise the SDK](/risk-management/sessions/non-hosted-sessions/3-d-secure-mobile-sd-ks#id-3DSecuremobileSDKs-initialize). We've included some code examples below to show you how you might build the object.
