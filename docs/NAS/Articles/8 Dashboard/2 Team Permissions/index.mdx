...
![title](/NAS/Dashboard/TeamPermissions.png)
...
1. In _Settings > Team Permissions_, select _Add user_. A pop-up opens.
...
A confirmation message pops up and the new user is added to the bottom of the list on the _Team Permissions_ screen.
...
1. In _Settings > Team Permissions_, select a user. This will open the details on the right side of your screen.
2. In the top right of the details pane, select _Delete_ user.
3. To confirm, select _Delete_ user again.
