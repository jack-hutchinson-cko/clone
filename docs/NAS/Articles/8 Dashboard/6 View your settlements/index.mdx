...
The _Settlements_ page shows a list of these settlements, ordered from the most recent (at the top of the page) to the oldest. For each settlement, you will see:
...
![title](/NAS/Dashboard/View_your_settlements/settlements_screen.png)

---

### Search

You can search for a specific settlement using the search bar. Simply type or paste either the _billing descriptor_ or _settlement ID_ into the bar and hit enter.

![title](/NAS/Dashboard/View_your_settlements/search_billing.png)

![title](/NAS/Dashboard/View_your_settlements/search_settlement.png)
...
![title](/NAS/Dashboard/View_your_settlements/settlement_details.png)

---

### Transactions breakdown

At the bottom of the _Settlement details_ page, you’ll see _Transactions breakdown_. Here you can download a report of [financial actions by payout ID](/reporting/reconciliation-reports/financial-actions-reports), which gives a breakdown of transactions for that particular settlement.
