...
2. Select the payment you would like to see the fee breakdown for. This takes you to the _Payments details_ page. 
3. Scroll to the _Payment fees_ section.

![title](/NAS/Dashboard/View_your_payment_fees/payment_fees.png)

---

### Payment fee breakdown

In the _Payment fees_ section, you will see _Scheme and other network fees_ and _Checkout fees_. _Checkout fees_ are a total sum of fees incurred along the payment lifecycle. When you expand this, you'll see a breakdown of the types of fees grouped by categories.
...
![title](/NAS/Dashboard/View_your_payment_fees/payment_fee_breakdown.png)
