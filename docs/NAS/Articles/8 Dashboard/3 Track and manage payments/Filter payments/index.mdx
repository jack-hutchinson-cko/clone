...
![title](/NAS/Dashboard/Filter_payments/search_bar.png)
...
![title](/NAS/Dashboard/Filter_payments/search_status_filter.png)

If your search term includes a space, you must wrap it in quotation marks. For example, `"John Doe"`.

![title](/NAS/Dashboard/Filter_payments/search_string.png)
...
4. Press _Enter_ or select _See all results_ to apply your filter. The _Payments_ screen will be updated to show your results.
