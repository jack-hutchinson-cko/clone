...
- **Challenge**: If you want to defend against the dispute, because you have evidence that the transaction is valid, select _Submit evidence_. This will take you to the [disputes form where you can upload your evidence](/dashboard/manage-disputes#Managedisputes-submitevidence).
