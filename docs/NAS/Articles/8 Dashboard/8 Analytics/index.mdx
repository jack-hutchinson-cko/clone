...
The Preset boards tab displays a list of example boards created by <ExternalLink href="https://www.checkout.com/" target="_blank">Checkout.com</ExternalLink>, available to all users. Use these preset boards as inspiration to create your own, or to provide quick insight into your payments data without having to create a board yourself.
