...
1. Go to either:
    - <ExternalLink href="https://dashboard.checkout.com) (production" >https://dashboard.checkout.com</ExternalLink>
    - <ExternalLink href="https://dashboard.sandbox.checkout.com) (sandbox" >https://dashboard.sandbox.checkout.com</ExternalLink>
