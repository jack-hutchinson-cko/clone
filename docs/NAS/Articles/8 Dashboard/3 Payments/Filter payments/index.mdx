...
<img src="/NAS/Dashboard/Filter_payments/search_bar.png" withFullscreenPreview alt="Filter payments search bar"/>
...
<img src="/NAS/Dashboard/Filter_payments/search_status_filter.png" withFullscreenPreview alt="Filter payments search status filter"/>

If your search term includes a space, you must wrap it in quotation marks. For example, `"John Doe"`.

<img src="/NAS/Dashboard/Filter_payments/search_string.png" withFullscreenPreview alt="Filter payments search string"/>
