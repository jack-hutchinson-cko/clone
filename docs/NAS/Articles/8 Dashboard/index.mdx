...
If you have an <ExternalLink href="https://www.okta.com/products/single-sign-on/" target="_blank">Okta</ExternalLink> account, and you have the Dashboard assigned to it, you can log in using SSO. Follow our [initial](/dashboard/set-up#Initial_Okta_setup) and [final](/dashboard/set-up#Final_client_Okta_setup_and_testing) setup guides to set up SSO.
