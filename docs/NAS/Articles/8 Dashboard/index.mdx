...
If you have an [Okta](https://www.okta.com/products/single-sign-on/) account, and you have the Dashboard assigned to it, you can log in using SSO. Follow our [initial](/dashboard/set-up#Initial_Okta_setup) and [final](/dashboard/set-up#Final_client_Okta_setup_and_testing) setup guides to set up SSO.
...
<img src="/NAS/Dashboard/Get_started/icon-navigate-the-dashboard.png" withFullscreenPreview alt="Navigate the dashboard"/>
...
<img src="/NAS/Dashboard/Get_started/homepage.png" withFullscreenPreview />
...
<img src="/NAS/Dashboard/Get_started/date_selector.png" withFullscreenPreview />
