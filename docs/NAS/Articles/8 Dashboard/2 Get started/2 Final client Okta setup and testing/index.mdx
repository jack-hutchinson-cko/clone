...
3. Replace the placeholder values for the _Single Sign-On URL_ and the _Audience URI_ with the parameters we previously shared with you.
...
2. Complete the email address field, then select _Next_. A _Single-Sign On_ button is displayed.
