...
- Have you registered to begin using Payment Links? Contact your Solution Engineer or <ExternalLink href="integration@checkout.com">integration@checkout.com</ExternalLink>. During integration, you'll be able to specify your payment capture and 3D Secure settings.
...
- To practise API calls <ExternalLink href="https://www.checkout.com/get-test-account" target="_blank">request a test account</ExternalLink> and use the Sandbox version of the endpoint.
...
You can view a request example with all of these fields on our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#operation/createAPaymentLinkSession" target="_blank">API reference</ExternalLink>.
...
For a full explanation of the fields, see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Payment-Links" target="_blank">API reference</ExternalLink>.
