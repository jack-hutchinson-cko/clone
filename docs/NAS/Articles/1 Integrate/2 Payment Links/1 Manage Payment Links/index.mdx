...
You can view a request example with all of these fields on our [API reference](https://api-reference.checkout.com/preview/crusoe/#operation/createAPaymentLinkSession).
...
For a full explanation of the fields, see our [API reference](https://api-reference.checkout.com/preview/crusoe/#tag/Payment-Links).
