...
If you haven't already, [create a free test account now](https://www.checkout.com/get-test-account). This will give you access to the [Dashboard](https://dashboard.checkout.com/login), where you'll find your `secret_key` and `public_key`, which you'll need to make requests to our API.
