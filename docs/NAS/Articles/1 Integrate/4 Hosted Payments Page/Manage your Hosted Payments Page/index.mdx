...
* Set up [webhooks](/workflows) to be notified when the payment has been approved, so you can continue the sales fulfilment flow.
...
To get a detailed view of all required and optional fields, see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Hosted-Payments-Page">API reference</ExternalLink>.
...
You can view a request example with all of these fields on our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Hosted-Payments-Page">API reference</ExternalLink>.
...
For a full explanation of the fields, see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Hosted-Payments-Page">API reference</ExternalLink>.
