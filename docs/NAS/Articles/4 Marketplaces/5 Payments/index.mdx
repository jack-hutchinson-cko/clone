...
Include all relevant fields using our <RequestTag type="POST"/>`/payments` endpoint. See our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/" target="_blank">API reference</ExternalLink> for all required and optional fields.
...
When you receive a `422`, please check the API request to make sure you've included all of the required values. You can see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/) for a full overview." target="_blank">API reference</ExternalLink>.
...
<ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Marketplace" target="_blank">Learn more</ExternalLink>
</ContentPanel>
