...
Include all relevant fields using our <RequestTag type="POST"/>`/payments` endpoint. See our [API reference](https://api-reference.checkout.com/preview/crusoe/) for all required and optional fields.
...
When you receive a `422`, please check the API request to make sure you've included all of the required values. You can see our [API reference](https://api-reference.checkout.com/preview/crusoe/) for a full overview.
