...
<ContentPanel title="About onboarding sub-entities" imgSrc="/NAS/Marketplaces/onboard-sub-entities.svg">

Find out more about onboarding and verification for your sub-entities.

[Learn more](/marketplaces/about-onboarding)

</ContentPanel>
<ContentPanel title="Onboard sub-entities" imgSrc="/NAS/Marketplaces/onboard-sub-entities.svg">

We'll **walk you through** the entire process of onboarding a sub-entity from your Platform onto our solution.

[Lite account](/marketplaces/about-onboarding/onboard-a-sub-entity-lite)

[Full account](/marketplaces/about-onboarding/onboard-a-sub-entity-full)
