...
We will trigger our checks only when we have all of the information required to conduct them. If our due diligence checks pass, payment capabilities for this sub-entity will be enabled. Read more about this on our [onboarding information page](/marketplaces/about-onboarding).
...
You will also notice there is a status field set to `pending`. This is because due diligence checks haven't been completed yet. Read more [about statuses](marketplaces/about-onboarding).
