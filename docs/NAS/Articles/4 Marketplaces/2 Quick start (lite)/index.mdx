...
- You have your `client_id` and `client_secret`, so you can generate access tokens with the required scopes. See our [authentication workflow](/resources/api-authentication/oauth-2-0-client-credentials) for more information.
