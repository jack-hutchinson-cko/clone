...
You will also notice there is a status field set to requirements_due. This is because we still require more information before we can conduct due diligence checks – in this case, it is the identification document. Read more [about statuses](/marketplaces/about-onboarding).
...
Use the `id` returned to upload an identification document. Find out how to do this using our [Files API](/marketplaces/about-onboarding/upload-a-file).

You then need to update the sub-entity with this identification documentz attached, so we trigger due diligence checks.

Read more about how to do this on our [onboarding page](/marketplaces/about-onboarding/onboard-a-sub-entity-full).
...
To provide greater flexibility, we don’t need you to provide all of the data required for due diligence checks upfront. You can onboard a sub-entity with the minimum required information and then enrich it later through updates. We will trigger our checks only when we have all of the information required to conduct them. If our due diligence checks pass, payment and payout capabilities for this sub-entity will be enabled. Read more about this on our [onboarding information](/marketplaces/about-onboarding) page.
...
Use the `id` returned to upload an identification document. Find out how to do this using our [Files API](/four/marketplaces/about-onboarding/upload-a-file).
