...
- Although not mentioned in the table below, `reference`, `contact_details` and `profile` are always required. See the <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Marketplace) for more information." target="_blank">API reference</ExternalLink>.
...
<ButtonLinkSecondary href="/marketplaces/onboarding/api">Marketplace API</ButtonLinkSecondary>
&nbsp;
<ButtonLinkSecondary href="/marketplaces/onboarding/dashboard">Dashboard</ButtonLinkSecondary>
