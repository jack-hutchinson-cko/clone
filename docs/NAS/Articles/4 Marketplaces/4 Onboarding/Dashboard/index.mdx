...
![Onboard sub-entities in the Dashboard](/NAS/Marketplaces/onboard-full-screen.png)
...
You may need to update a sub-entity because some of their details have changed, or to fulfil specific [due diligence requirements](/marketplaces/onboarding#Information_required). 
