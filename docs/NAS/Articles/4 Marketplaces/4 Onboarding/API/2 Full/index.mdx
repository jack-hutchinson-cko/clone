...
Don't want to use code? You can [onboard sub-entities using our friendly user interface](/marketplaces/onboard/user-interface) in the Dashboard.
...
To get a detailed view of all required and optional fields, see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Marketplace/paths/~1marketplace~1entities~1{id}/put" target="_blank">API reference.</ExternalLink>
...
Sandbox is a testing area, so you can practise API calls. <ExternalLink href="https://www.checkout.com/get-test-account" target="_blank">Request a test account.</ExternalLink>
...
When you receive a `422`, please check the API request to make sure you've included all of the required values. You can see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Marketplace/paths/~1marketplace~1entities/post) for a full overview." target="_blank">API reference</ExternalLink>.
...
To get a detailed view of all required and optional fields, see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Marketplace/" target="_blank">API reference.</ExternalLink>
...
<ContentPanel variant="heading" title="Accept a payment" imgSrc="/NAS/Marketplaces/accept-a-payment.svg">

Process payments on behalf of your sub-entities.

[Learn more](/marketplaces/accept-a-payment)
...
[Find out more](/marketplaces/onboard/api/full/upload-a-file)
