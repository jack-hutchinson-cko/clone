...
Don't want to use code? You can [onboard sub-entities using our friendly user interface](/marketplaces/onboard/dashboard) in the Dashboard.
...
<ContentPanel title="Accept a payment" imgSrc="/NAS/Marketplaces/accept-a-payment.svg">
...
[Find out more](/marketplaces/payments)
