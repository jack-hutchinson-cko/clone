...
Occurs when transaction has invalid card data. Refer to the page on [recommendation codes](/resources/codes/recommendation-codes) for advice.
...
Occurs when a transaction does not comply with card policy. Refer to the page on [recommendation codes](/resources/codes/recommendation-codes) for advice.
...
Occurs when a transaction is suspected to be fraudulent. Refer to the page on [recommendation codes](/resources/codes/recommendation-codes) for advice.
