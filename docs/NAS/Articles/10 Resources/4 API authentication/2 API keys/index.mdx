...
Public keys are used for client-side authentication and only have access to a limited set of our APIs – mostly those called as part of your payment environment. You'll use them when tokenizing card information through [Frames](/payments/accept-payments/frames) or for [Google Pay](/payments/payment-methods/google-pay).
