...
- The status:
    - If your payment is partially captured or partially refunded, the amount of the partial action is displayed in a tooltip when hovering over the (info) next to the status.
...
![title](/NAS/Dashboard/Track_and_manage_payments/payments_screen.png)

<TipBox>

Learn how to quickly [filter and search your payments](/dashboard/track-and-manage-payments/filter-payments).
...
Here, you can also capture, [void or refund a payment](/dashboard/track-and-manage-payments#Trackandmanagepayments-paymentactions).

![title](/NAS/Dashboard/Track_and_manage_payments/payment_details_panel.png)
...
1. In the *Payments screen*, click on a payment to view its details.
