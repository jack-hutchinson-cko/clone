...
If you have an Okta account, and you have the Dashboard assigned to it, you can log in using SSO. Follow our initial and final setup guides to set up SSO.
