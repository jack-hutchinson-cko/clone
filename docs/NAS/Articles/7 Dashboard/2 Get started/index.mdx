...
If you want to view older data, select _Date filter_ in the top right and then select a date or date range. To select a date range, select the start date then select on the end date. Your selected date range will be highlighted in green.
