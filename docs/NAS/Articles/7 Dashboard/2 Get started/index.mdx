...
<Card variant="media" title="Single Sign-On (SSO)" imgSrc="/NAS/Dashboard/Get started/icon-sso.svg" href=''>
...
<Card variant="media" title="Credentials" imgSrc="/NAS/Dashboard/Get started/icon-credentials.svg" href=''>
