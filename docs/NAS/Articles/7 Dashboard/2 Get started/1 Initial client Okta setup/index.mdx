...
3. Click _Applications > Create New App > SAML 2.0 > Create_.
4. Fill the App Name field with `Checkout.com`.
5. Upload the following App Logo and click _Next_.
...
10. Click on _Finish_ then _Next_ to complete the initial setup.

---

## Step 3: Extract the SSO configuration

1. Go back to the application’s Sign-On tab and click _View Setup Instructions_.
