...
- **Accept**: If you think the dispute is legitimate, because, for example, you know the transaction is fraudulent, click _Accept dispute_. You don’t have to do anything else; the funds will already have been debited from your account.
- **Challenge**: If you want to defend against the dispute, because you have evidence that the transaction is valid, click _Submit evidence_. This will take you to the [disputes form where you can upload your evidence](/dashboard/manage-disputes#Managedisputes-submitevidence).
...
The evidence you submit should be relevant to the reason for the dispute. To help, we outline the recommended evidence for the particular dispute you’re responding to. Alternatively, click _General_ to see all the evidence types you can upload.
...
3. If at any point you want to save your progress and come back to the form later, click _Save and continue later_. You, or another user, can then pick up where you left off.The dispute status will remain `EVIDENCE REQUIRED`.
4. If you’ve uploaded all the evidence you want to, click _Submit evidence_.
