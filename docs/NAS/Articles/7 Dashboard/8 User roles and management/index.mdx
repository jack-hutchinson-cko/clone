...
Administrators (including the Owner) have access to the _User management_ screen (under _Settings_), which provides a record of all users on an account. Depending on your entity access, the list on view will filter to reflect the users whose details you can edit, depending on your business needs. The Administrator Owner can view and manage all users for all entities on the account. 
...
To view more information or edit a user's details, select a row. The details pane opens on the right side of the page:
...
1. In _Settings > User management_, select _Add user_. A pop-up opens.
...
3. Select the _Role_ you want the user to have. By default, this is set to _Read Only_.
...
A confirmation message pops up and the new user is added to the bottom of the list on the _User management_ screen.
...
1. In _Settings > User management_, select a user. The details pane opens on the right side of your screen.
...
1. In _Settings > User management_, select on a user. The details pane opens on the right side of your screen.
2. In the top right of the details pane, select _Delete_ user.
...
1. In _Settings > User management_, select a user. The details pane opens on the right side of your screen.
2. In the top right of the details pane, select _Transfer ownership_. Note that this button is only visible to the Administrator Owner.
