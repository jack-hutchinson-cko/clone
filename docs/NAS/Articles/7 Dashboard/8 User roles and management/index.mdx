...
1. In Settings > User management, select _Add user_. A pop-up opens.
...
1. In Settings > User management, select a user. The details pane opens on the right side of your screen.
...
1. In Settings > User management, select on a user. The details pane opens on the right side of your screen.
