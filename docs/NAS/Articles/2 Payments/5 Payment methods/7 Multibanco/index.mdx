...
1.  [Request a Multibanco payment](/payments/payment-methods/multibanco#Request_a_payment)
2.  [Redirect the customer](/payments/payment-methods/multibanco#Redirect_the_customer)
