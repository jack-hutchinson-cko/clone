...
1.  [Request a Bancontact payment](/payments/payment-methods/bancontact#Request_a_payment)
2.  [Redirect the customer](/payments/payment-methods/bancontact#Redirect_the_customer)
...
Bancontact supports both partial and full refunds. You can refund a payment through the <ExternalLink href="https://dashboard.checkout.com/login">Dashboard</ExternalLink> or by using the [refund API](/payments/manage-payments/refund-a-payment).
...
3.  Click _Submit_. You should then be redirected to your predefined success URL.
