...
1.  [Request a Bancontact payment](#Request_a_payment)
2.  [Redirect the customer](#Redirect_the_customer)
...
3.  Select _Submit_. You should then be redirected to your predefined success URL.
