...
Sofort supports both partial and full refunds. You can refund a payment through the <ExternalLink href="https://api-reference.checkout.com/#operation/refundAPayment" target="_blank">Hub](https://hub.checkout.com/v2) or using the [refund endpoint</ExternalLink> of the Unified Payments API.
