...
Sofort supports both partial and full refunds. You can refund a payment through the <ExternalLink href="https://hub.checkout.com/v2https://hub.checkout.com/v2" target="_blank">Hub</ExternalLink> or using the <ExternaLink href="https://api-reference.checkout.com/#operation/refundAPayment" target="_blank">refund endpoint</ExternalLink> of the Unified Payments API.
