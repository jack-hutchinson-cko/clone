...
Start accepting payments using <ExternalLink href="https://www.checkout.com/payment-methods/accept/sofort" target="_blank">Sofort</ExternalLink>, a favorite payment method in Europe.
...
Sofort supports both partial and full refunds. You can refund a payment through the <ExternalLink href="https://hub.checkout.com/v2https://hub.checkout.com/v2" target="_blank">Hub</ExternalLink> or using the <ExternalLink href="https://api-reference.checkout.com/#operation/refundAPayment" target="_blank">refund endpoint</ExternalLink> of the Unified Payments API.
...
*   <ExternalLink href="https://www.checkout.com/get-test-account" target="_blank">Create a test account</ExternalLink>.
...
The payment remains in a deferred capture state. To test a full capture, contact us at <ExternalLink href="integration@checkout.com">integration@checkout.com</ExternalLink> to request that a transaction be manually set to captured.
