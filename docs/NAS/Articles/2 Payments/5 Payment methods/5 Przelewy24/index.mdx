...
1.  [Request a payment](/payments/payment-methods/przelewy24#Request_a_payment)
2.  [Redirect the customer](/payments/payment-methods/przelewy24#Redirect_the_customer)
...
Przelewy24 supports both partial and full refunds. You can refund a payment through the <ExternalLink href="https://dashboard.checkout.com/login">Dashboard</ExternalLink> or by using the [refund API](/payments/manage-payments/refund-a-payment).
