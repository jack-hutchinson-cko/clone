...
When you test a payment refund, the transaction is likely to remain in a deferred refund state. Contact us at <ExternalLink href="integration@checkout.com">integration@checkout.com</ExternalLink> to request triggering a simulation batch job that ensures the completion of the refund.
