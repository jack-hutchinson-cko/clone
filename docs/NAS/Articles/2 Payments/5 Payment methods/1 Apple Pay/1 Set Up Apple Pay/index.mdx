...
5.  Upload this file to your server so it's accessible at the following location (replacing <ExternalLink href="https://yourdomain.com/.well-known/apple-developer-merchantid-domain-association.txt" target="_blank">yourdomain.com](http://yourdomain.com/) with the URL of your domain): [https://yourdomain.com/.well-known/apple-developer-merchantid-domain-association.txt</ExternalLink>. To do this, create a folder called `.well-known` in the root directory of your website and put the `.txt` file in that folder.
