...
*  <ExternalLink href="https://applepaydemo.apple.com/" target="_blank">Apple Pay Web](https://developer.apple.com/documentation/apple_pay_on_the_web). See a [demo</ExternalLink>.
