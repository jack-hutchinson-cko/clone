...
*   An Apple Developer account. <ExternalLink href="https://developer.apple.com/programs/enroll/" target="_blank">Sign up for one here</ExternalLink>.
...
1.  In your Apple Developer account, go to the <ExternalLink href="https://developer.apple.com/account/resources/identifiers/add/merchant" target="_blank">Add Merchant IDs section</ExternalLink>, select _Merchant IDs_ and select _Continue_.
...
To get a detailed view of all required and optional fields, see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe" target="_blank">API reference</ExternalLink>.
...
1.  Log in to your Apple Developer account, go to the <ExternalLink href="https://developer.apple.com/account/resources/identifiers/list/merchant" target="_blank">Merchant IDs list section</ExternalLink> and select the merchant ID you created in step 1.
...
5.  Upload this file to your server so it's accessible at the following location (replacing <ExternalLink href="https://yourdomain.com/" target="_blank">yourdomain.com</ExternalLink> with the URL of your domain): <ExternalLink href="https://yourdomain.com/.well-known/apple-developer-merchantid-domain-association.txt" target="_blank">https://yourdomain.com/.well-known/apple-developer-merchantid-domain-association.txt</ExternalLink>. To do this, create a folder called `.well-known` in the root directory of your website and put the `.txt` file in that folder.
...
3.  Log in to your Apple Developer account, go to the <ExternalLink href="https://developer.apple.com/account/resources/identifiers/list/merchant" target="_blank">Merchant IDs list section</ExternalLink> and select the merchant ID you created in step 1.
...
*  [Checkout.com](http://checkout.com/) linked to your merchant ID.
...
*  <ExternalLink href="https://developer.apple.com/documentation/apple_pay_on_the_web" target="_blank">Apple Pay Web</ExternalLink>. See a <ExternalLink href="https://applepaydemo.apple.com/" target="_blank">demo</ExternalLink>
*  <ExternalLink href="https://developer.apple.com/documentation/apple_pay_on_the_web" target="_blank">Apple Pay Mobile</ExternalLink>.
...
<img src="/NAS/Payments/PaymentMethods/apple_pay_flow.png" withFullscreenPreview />
