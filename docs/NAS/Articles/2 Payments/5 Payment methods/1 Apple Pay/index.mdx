...
*   A <ExternalLink href="https://developer.apple.com/apple-pay/sandbox-testing/" target="_blank">sandbox Apple Pay wallet</ExternalLink>. (You cannot use a real Apple Pay wallet with real cards to test in sandbox.)
