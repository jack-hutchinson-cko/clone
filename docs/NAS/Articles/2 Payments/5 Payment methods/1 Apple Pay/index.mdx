...
The first step in processing an Apple Pay transaction is to convert this Apple Pay token into a [Checkout.com](http://checkout.com/) card token.
...
For the full API specification, see the <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Tokens" target="_blank">API reference</ExternalLink>.
...
For the full API specification, see the <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#operation/requestAPaymentOrPayout" target="_blank">API reference</ExternalLink>.
...
*   A <ExternalLink href="https://developer.apple.com/apple-pay/sandbox-testing/). (You cannot use a real Apple Pay wallet with real cards to test in sandbox." target="_blank">sandbox Apple Pay wallet</ExternalLink>. (You cannot use a real Apple Pay wallet with real cards to test in sandbox.)
