...
Use a refund to return a payment to a customer. Refunds can be made in the <ExternalLink href="https://hub.checkout.com/v2" target="_blank">Hub</ExternalLink> or by using this API endpoint.
