...
Find out what the different fields in your successful response mean by looking at our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/" target="_blank">API reference</ExternalLink>
