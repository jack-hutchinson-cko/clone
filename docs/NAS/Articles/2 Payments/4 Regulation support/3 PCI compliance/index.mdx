...
Any organization involved with the processing, transmission, or storage of card data must comply with the <ExternalLink href="https://www.pcisecuritystandards.org/pci_security/) (PCI DSS" target="_blank">Payment Card Industry Data Security Standards</ExternalLink>.
