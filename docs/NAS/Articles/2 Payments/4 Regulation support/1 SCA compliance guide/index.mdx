...
To implement 3D Secure authentication and comply with SCA, you need to add the following fields to your payment requests. See our [3D Secure API integration guide](/risk-management/3-d-secure/3d-secure-2-api-integration) for more details.
