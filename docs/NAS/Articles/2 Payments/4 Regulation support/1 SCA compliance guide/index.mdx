...
- Many common European payment methods, like [Bancontact](/payments/payment-methods/cards/bancontact), [iDEAL](/payments/payment-methods/ideal), and [Multibanco](/payments/payment-methods/cash-and-atm-payment/multibanco), should also follow the SCA requirements.
