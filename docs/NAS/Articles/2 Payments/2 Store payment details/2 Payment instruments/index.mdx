...
Before creating a bank account payment instrument, use the <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Instruments/paths/~1validation~1bank-accounts~1{country}~1{currency}/get" target="_blank">get bank account field formatting endpoint</ExternalLink> to check which fields are required for the country and currency of the account.
