...
Even if SCA applies to your business, some transactions fall [outside the scope of SCA](/payments/regulation-support/sca-compliance-guide#SCAcomplianceguide-outofscope), or can benefit from possible exemptions if the customer's bank approves.
