...
1.  In your Apple Developer account, go to the [Add Merchant IDs section](https://developer.apple.com/account/resources/identifiers/add/merchant), select **Merchant IDs** and click **Continue**.
...
## Step 2: Create your merchant IDs in your Apple Pay Developer account
...
2.  In the *Apple Pay Payment Processing Certificate* section (make sure you’re not in the *Apple Pay Merchant Identity Certificate* section), click *Create Certificate*.
3.  Respond *No* to the question about processing in China and click *Continue*.
4.  Upload the `.csr` file from the previous step and click *Continue*.
5.  Click *Download* to get your payment processing certificate – a `.cer` file.
...
1.  Log in to your Apple Developer account, go to the [Merchant IDs list section](https://developer.apple.com/account/resources/identifiers/list/merchant) and click on the merchant ID you created in step 1.
...
3.  Log in to your Apple Developer account, go to the [Merchant IDs list section](https://developer.apple.com/account/resources/identifiers/list/merchant) and click on the merchant ID you created in step 1.
...
*  [Apple Pay Mobile](https://developer.apple.com/documentation/apple_pay_on_the_web).
...
Now you've configured and integrated with Apple Pay, you're ready to [accept Apple Pay payments through our payment gateway](https://docs.checkout.com/preview/drafts/nas/apple-pay).
