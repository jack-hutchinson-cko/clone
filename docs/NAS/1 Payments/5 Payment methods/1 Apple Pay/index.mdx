...
Before you can accept Apple Pay payments, you need to [set up and configure Apple Pay](https://docs.checkout.com/preview/drafts/nas/apple-pay/set-up-apple-pay).
...
<TipBox variant="info">
  ...
  Alternatively, if you want to decrypt the Apple Pay token yourself and process a payment, follow our [pay with a pre-decrypted token guide](https://docs.checkout.com/preview/drafts/nas/apple-pay/pay-with-a-pre-decrypted-apple-pay-token).

</TipBox>

### Endpoints

For the full API specification, see the [API reference](https://api-reference.checkout.com/preview/crusoe/#tag/Tokens).
...
For the full API specification, see the [API reference](https://api-reference.checkout.com/preview/crusoe/#operation/requestAPaymentOrPayout).
...
Once you've got a compatible device and a sandbox Apple Pay wallet, you can add one of the following test cards to it. See our [testing guide](https://docs.checkout.com/four/testing) for more information.
