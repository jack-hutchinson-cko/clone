...
Allows you to use one of the supported languages or a custom object. Refer to the [Frames customization guide](https://docs.checkout.com/four/payments/accept-payments/frames/frames-customization-guide) for more information.
...
The country field only accepts [two-letter ISO country codes](https://docs.checkout.com/four/resources/codes/currency-codes).
