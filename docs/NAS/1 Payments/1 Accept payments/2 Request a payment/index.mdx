...
- [using a token](/payments/accept-payments/request-a-payment#Requestapayment-token)
- [using a network token](/payments/accept-payments/request-a-payment)
- [using full card details ](/payments/accept-payments/request-a-payment#Requestapayment-card)(requires SAQ D PCI compliance)
