...
- [using a token](https://docs.checkout.com/four/payments/accept-payments/request-a-payment#Requestapayment-token)
- [using a network token](https://docs.checkout.com/four/payments/accept-payments/request-a-payment)
- [using full card details ](https://docs.checkout.com/four/payments/accept-payments/request-a-payment#Requestapayment-card)(requires SAQ D PCI compliance)
...
If you are [SAQ D PCI compliant](https://docs.checkout.com/four/payments/regulation-support/pci-compliance), you can use our Full Card API to request a payment using the full card details.
