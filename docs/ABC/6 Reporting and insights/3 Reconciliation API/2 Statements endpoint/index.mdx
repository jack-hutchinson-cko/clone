...
See more information about the parameters available for this endpoint [above](https://docs.checkout.com/reporting-and-insights/reconciliation-api/statements-endpoint#Statementsendpoint-statementIDpayments).
