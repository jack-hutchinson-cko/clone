...
<img maxWidth={300} src="/docs/Integrate/configure_webhook.png" title="Configure webhook" />
...
<img
  maxWidth={500}
  src="/docs/Integrate/configure_checkout_plugin.png"
...
You can now either [go live](#Go_live) as-is or [extend your configuration](/integrate/e-commerce-platforms/prestashop/go-further-with-prestashop).
...
You can extend your configuration to [add more payment methods](/integrate/e-commerce-platforms/prestashop/go-further-with-prestashop), use [3D Secure payments](/integrate/e-commerce-platforms/prestashop/go-further-with-prestashop), and more.
