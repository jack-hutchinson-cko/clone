...
<img maxWidth={300} src="/docs/Integrate/create_webhook-magento-2.png" title="Create webhook Magento 2" />

5. Click on the webhook you just created, and make a note of the private shared API key.

<img maxWidth={300} src="/docs/Integrate/webhook–magento-2.png" title="Webhook Magento 2" />
...
<img maxWidth={800} src="/docs/Integrate/Magento_2_plugin_global_settings.png" title="Magento 2 plugin global settings" />
...
7. Enter your **Secret Key** and **Public Key**. If you're testing, make sure you use the API keys from your sandbox Hub account, then click Set Webhooks to automatically register your webhooks in [Checkout.com](http://checkout.com/) Hub.

<img src="/docs/Integrate/Magento_2_payments_settings_2.gif" title="Magento 2 payments settings 2" />
...
You can now either [go live](#Go_live) as-is or [extend your configuration](/integrate/e-commerce-platforms/magento-2/go-further-with-magento-2).
...
You can extend your configuration to [add more payment methods](/integrate/e-commerce-platforms/magento-2/go-further-with-magento-2#Add_more_payment_methods), use [3D Secure payments](https://docs.checkout.com/integrate/e-commerce-platforms/magento-2/go-further-with-magento-2#Enable_3d_secure_payments), and more.