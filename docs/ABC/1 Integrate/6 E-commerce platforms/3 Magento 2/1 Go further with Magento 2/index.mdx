...
1. Log in to your Magento Admin Panel and go to _Stores > Configuration > Sales > Payment Methods_, find the Checkout.com plugin, click **Configure** and expand **Alternative Payments**.

<img
  maxWidth={800}
  src="/docs/Integrate/alternative_payments_magento_2.png"
...
<img src="/docs/Integrate/saved_card_payments.png" title="Saved Card Payments" />
