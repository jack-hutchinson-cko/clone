...
<img maxWidth={300} src="/docs/Integrate/Screenshot+2021-03-01+at+16.07.05.png" />

7.  Click on the webhook you just created, and make a note of the private shared API key.

<img maxWidth={400} src="/docs/Integrate/webhook_woocommerce.png" />
<TipBox variant="info">
...
<img maxWidth={700} src="/docs/Integrate/woocommerce_deactivate_plugin.png" />
...
<img maxWidth={700} src="/docs/Integrate/woocommerce_plugin_settings.png" />
...
9.  Click the *Card Settings* tab, then click **Save changes**. Do the same for the *Order Settings*. This will activate our default configuration.
...
You can extend your configuration to [add more payment methods](/integrate/e-commerce-platforms/woocommerce/go-further-with-woocommerce#Add_more_payment_methods) or [use 3DS](/integrate/e-commerce-platforms/woocommerce/go-further-with-woocommerce#Enable_3D_Secure_payments).
