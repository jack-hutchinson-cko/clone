...
3.  Click **Settings** under *WooCommerce [Checkout.com](http://Checkout.com) Gateway*.
...
7.  Click the empty box next to *Alternative Payment Methods*. A drop-down menu of all available methods appears.
...
2.  Click on the test payment. The *Customer details* pane opens.
3.  Click **Capture** in the top right.
4.  Click **Capture payment**. The payment's *Action* column is updated to say `CAPTURE`. The totals on your dashboard are also updated.
...
<img maxWidth={700} src="/docs/Integrate/woocommerce_order_details.png" />
