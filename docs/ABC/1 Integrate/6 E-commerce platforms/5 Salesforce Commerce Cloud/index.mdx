...
<img maxWidth={300} src="/docs/Integrate/sfcc-create_webhook.png" alt="SFCC Create Webhook" />

7. Click on the webhook you just created, and make a note of the private shared API key.

<img maxWidth={400} src="/docs/Integrate/sfcc-webhook.png" alt="SFCC Webhook" />
...
<img maxWidth={700} src="/docs/Integrate/Frame+2366.png" />
...
<img
  maxWidth={700}
  src="/docs/Integrate/sfcc-site_import_export.png"
...
<img maxWidth={700} src="/docs/Integrate/sfcc-account_settings.png" alt="SFCC Account settings" />
