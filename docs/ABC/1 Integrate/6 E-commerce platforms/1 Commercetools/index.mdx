...
2. [Set up the frontend](#Set_up_the_frontend), which involves integrating [Frames](https://docs.checkout.com/preview/drafts/getting-started-private/integration-methods/frames) for card payments and our [Klarna SDK](/payments/payment-methods/invoice-and-pay-later/klarna) for Klarna payments.
...
<img maxWidth={700} src="/docs/Integrate/apple_pay_flow.png" />
...
1. Scroll down to the Webhooks section of the page and click **New webhook**.
...
You can see these interactions in your commercetools Merchant Center _by going to Order list > Order_ and clicking the _Payment_ tab.
...
1. Log in to the commercetools Merchant Center, go to Settings > Developer Settings and click **Create API Client**.
...
- Integrate [Frames](https://docs.checkout.com/preview/drafts/getting-started-private/integration-methods/frames) to accept card payments.
...
the reference field in the [Hub](https://hub.checkout.com/v2)
...
For more testing, commercetools have created a [Postman collection](https://consumerpayments.postman.co/workspaces/7c5d60af-d230-476e-a98a-5126a55ccbd2/collections).