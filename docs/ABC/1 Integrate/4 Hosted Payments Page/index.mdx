...
Hosted Payments Page now accepts [five more languages](https://docs.checkout.com/integrate/product-support) – French, Italian, Spanish, German and Dutch.
...
![title](/docs/Hosted+Payments+page.png)
...
<Iframe
  src="https://pay.sandbox.checkout.com/examples/docs-example/"
  height="700"
  width="100%"
></Iframe>
