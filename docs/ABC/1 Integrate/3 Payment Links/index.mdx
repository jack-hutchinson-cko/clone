...
Payment Links now accepts [five more languages](https://docs.checkout.com/integrate/product-support) – French, Italian, Spanish, German and Dutch.
...
We've also created a table that lists [supported payment methods](https://docs.checkout.com/integrate/product-support), languages and other features.
...
5. After the payment's been processed, you'll be notified by a [webhook](https://docs.checkout.com/reporting-and-insights/webhooks).

![title](/docs/Payment+links.png)
...
1. In the _Bank name, BLZ, IBAN or BIC_ field, enter `88888888`, and then click **Next**.
...
<ButtonLink href="https://docs.checkout.com/integrate/product-support">Learn more</ButtonLink>
