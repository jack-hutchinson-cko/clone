...
You can simulate a dispute (also called chargeback) by using the following payment methods and corresponding amounts in a payment request. This will work with any of our [test card numbers](/testing/test-card-numbers).
