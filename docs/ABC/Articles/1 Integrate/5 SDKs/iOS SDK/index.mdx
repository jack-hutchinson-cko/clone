...
<img src="/docs/Integrate/SDKs/iOS SDK/iOS.png" withFullscreenPreview />
...
<ExternalLink href="https://swift.org/package-manager/" target="_blank">Swift Package Manager</ExternalLink> is a tool for automating the distribution of Swift code and is integrated into the Swift compiler.
...
<ExternalLink href="https://developer.apple.com/documentation/passkit/apple_pay/offering_apple_pay_in_your_app" target="_blank">Read more about offering Apple Pay in your app</ExternalLink>.
