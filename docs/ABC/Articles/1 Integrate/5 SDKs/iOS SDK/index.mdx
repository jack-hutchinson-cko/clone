...
Make sure you have your `public_key`. You can find it in the [Hub](https://hub.checkout.com/), under _Settings > Channels_. If you don't have an account with us yet, you can [request a free test one](https://checkout.com/get-test-account).
...
### Handle the result by adding conformance to `ThreedsWebViewController`
