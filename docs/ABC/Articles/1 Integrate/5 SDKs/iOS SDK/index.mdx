...
Make sure you have your `public_key`. You can find it in the <ExternalLink href="https://hub.checkout.com" target="_blank">Hub</ExternalLink>, under _Settings > Channels_. If you don't have an account with us yet, you can [request a free test one](https://checkout.com/get-test-account).
