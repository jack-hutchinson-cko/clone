...
Make sure you have your public key. You can find it in the <ExternalLink href="https://hub.checkout.com" target="_blank">Hub</ExternalLink>, under _Settings > Channels_. If you don't have an account with us yet, you can <ExternalLink href="https://www.checkout.com/get-test-account" target="_blank">request a free test one</ExternalLink>.
...
If you're using the Android SDK with the deprecated Android Support Library, follow <ExternalLink href="https://github.com/checkout/frames-android/blob/master/readme-docs/archive/readme-v2-releases.md#releases-up-to-220" target="_blank">these steps</ExternalLink>.

</TipBox>

<TipBox variant="success" >

Learn more about <ExternalLink href="https://developer.android.com/studio/build" target="_blank">gradle files</ExternalLink>.
...
- [with the module's UI](/integrate/sd-ks/android-sdk#Usage_(with_the_module's_UI))
- [without the module's UI](/integrate/sd-ks/android-sdk#Usage_(without_the_module's_UI))
