...
- [with the module's UI](/integrate/frames-for-android#FramesforAndroid-with-UI)
- [without the module's UI](/integrate/frames-for-android#FramesforAndroid-without-UI)
