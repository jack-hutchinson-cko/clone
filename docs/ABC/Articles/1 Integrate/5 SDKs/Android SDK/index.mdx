...
<img src="/docs/Integrate/SDKS/Android SDK/Android.png" withFullscreenPreview/>
...
Make sure you have your public key. You can find it in the [Hub](https://hub.checkout.com/), under _Settings > Channels_. If you don't have an account with us yet, you can [request a free test one](https://www.checkout.com/get-test-account).
...
#### Step 2: Add the SDK its dependencies in gradle
...
If you're using the Android SDK with the deprecated Android Support Library, follow [these steps](https://github.com/checkout/frames-android/blob/master/readme-docs/archive/readme-v2-releases.md#releases-up-to-220).
...
- [with the module's UI](https://docs.checkout.com/integrate/frames-for-android#FramesforAndroid-with-UI)
- [without the module's UI](https://docs.checkout.com/integrate/frames-for-android#FramesforAndroid-without-UI)
...
Although we kept our demo simple, you have a lot of control over the appearance of your form—from the colors and styling, to whether you want to display one input field or several. Check out our [Customization guide](https://docs.checkout.com/integrate/sdks/android-sdk/customization-guide) for more details and examples.

#### Configuration options

You'll find a list of all the possible configuration options in our [Android SDK reference](https://docs.checkout.com/integrate/sdks/android-sdk/reference).

---

### Next steps

Now that you've got your card token, you're ready to [request a card payment](https://docs.checkout.com/payments/accept-payments/request-a-card-payment).
