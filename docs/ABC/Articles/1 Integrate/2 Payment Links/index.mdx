...
To begin using Payment Links, contact your Solution Engineer or <ExternalLink href="integration@checkout.com">integration@checkout.com</ExternalLink>. During integration, you'll be able to specify your payment capture and 3D Secure settings.
