...
To get a detailed view of all required and optional fields, see our <ExternalLink href="https://api-reference.checkout.com/" target="_blank">API reference</ExternalLink>.
...
You can view a request example with all of these fields on our <ExternalLink href="https://api-reference.checkout.com/#operation/createAPaymentLinkSession" target="_blank">API reference</ExternalLink>.
...
For a full explanation of the fields, see our <ExternalLink href="https://api-reference.checkout.com/#tag/Payment-Links" target="_blank">API reference</ExternalLink>.
