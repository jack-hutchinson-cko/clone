...
<img src="/docs/Integrate/Hosted Payments/Hosted+Payments+page.png" withFullscreenPreview />
...
1. In the _Bank name_, _BLZ_, _IBAN_ or _BIC field_, enter `88888888`, and then select _Next_.
