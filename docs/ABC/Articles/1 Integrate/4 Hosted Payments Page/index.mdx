...
1. In the Bank name, BLZ, IBAN or BIC field, enter `88888888`, and then select _Next_.
2. Enter `88888888` in the Account number field, and `123456` in the PIN field. Select _Next_.
3. Select any account, and then select _Next_.
4. Enter `12345` in the TAN field and select _Next_.
