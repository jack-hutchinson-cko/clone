...
If you haven't already, <ExternalLink href="https://hub.checkout.com/login" target="_blank">create a free test account now](https://www.checkout.com/get-test-account). This will give you access to the [Hub</ExternalLink>, where you'll find your `secret_key` and `public_key`, which you'll need to make requests to our API.
...
For the full specification, see our <ExternalLink href="https://api-reference.checkout.com/#operation/createAHostedPaymentsSession" target="_blank">API reference</ExternalLink>.
...
You can view a request example with all of these fields on our <ExternalLink href="https://api-reference.checkout.com/#operation/createAHostedPaymentsSession" target="_blank">API reference</ExternalLink>.
