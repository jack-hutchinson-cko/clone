...
Payment Links now accepts [15 more languages!](https://docs.checkout.com/integrate/product-support)
...
1. In the Bank name, BLZ, IBAN or BIC fields, enter `88888888`, and then select _Next_.
2. Enter `88888888` in the Account number field, and `123456` in the _PIN_ field. Select _Next_.
