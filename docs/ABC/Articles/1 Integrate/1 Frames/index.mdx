...
The new version of Frames was released on July 12, 2019. If you'd like to upgrade from the old version, simply follow our [migration guide](/integrate/frames/frames-migration-guide). If you need access to the legacy documentation, please contact our Support team at [support@checkout.com](support@checkout.com).
