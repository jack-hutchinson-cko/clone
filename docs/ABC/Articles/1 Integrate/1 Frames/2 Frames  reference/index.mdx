...
You can find it in the [Hub](https://hub.checkout.com/login).
...
YAllows you to use one of the supported languages or a custom object. Refer to the [Frames customization guide](https://docs.checkout.com/integrate/frames/frames-customization-guide) for more information.
...
Allows you to customize the look and feel of Frames' controlled fields. Refer to the [Frames customization guide](https://docs.checkout.com/integrate/frames/frames-customization-guide) for more information.
...
The country field only accepts two-letter ISO country codes. You can find a full list of these [here](https://docs.checkout.com/resources/codes/currency-codes).
...
<inlineCode wordBreak="break-word">paymentMethodChremoveAllEventHandlers(event)</inlineCode>
