...
If you discover any issues with the supported browsers, or would like to report a bug, please <ExternalLink href="https://www.checkout.com/contact-us" target="_blank">get in touch</ExternalLink>
...
You can find it in the <ExternalLink href="https://hub.checkout.com/login" target="_blank">Hub</ExternalLink>.
...
YAllows you to use one of the supported languages or a custom object. Refer to the [Frames customization guide](/integrate/frames/frames-customization-guide) for more information.
