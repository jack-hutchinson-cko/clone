...
1. Scroll down to the Webhooks section of the page and select _New webhook_.
...
You can see these interactions in your commercetools Merchant Center by going to _Order list > Order_ and selecting the Payment tab.
...
1. Log in to the commercetools Merchant Center, go to Settings > Developer Settings and select _Create API Client_.
