...
6. Using <ExternalLink href="https://impex.europe-west1.gcp.commercetools.com/playground), set `Types` as `endpoint`, and `create` as `command`, and then copy and paste in the following JSON files to install them (make sure you're in the right project when doing this" >commercetools' IMPEX</ExternalLink>:
...
Use the valid public key of your <ExternalLink href="https://hub.checkout.com/v2" >Checkout.com](http://checkout.com/) account. You can find this in the [Hub</ExternalLink>.
...
Use the valid secret key of your <ExternalLink href="https://hub.checkout.com/v2" >Checkout.com](http://checkout.com/) account. You can find this in the [Hub</ExternalLink>.
...
Your <ExternalLink href="https://hub.checkout.com/v2" >Checkout.com](http://checkout.com/) public key. You can find this in the [Hub</ExternalLink>.
