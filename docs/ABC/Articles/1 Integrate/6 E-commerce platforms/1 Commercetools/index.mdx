...
5. Copy the following details from the screen that appears, and send them to our Integration team at <ExternalLink href="integration@checkout.com">integration@checkout.com</ExternalLink> (you must save this information, as it is only displayed once):
