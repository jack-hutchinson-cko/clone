...
1.  [Download the latest Checkout.com SAP Commerce Cloud Connector](https://store.sap.com/dcp/en/product/display-0000059364_live_v1/Checkout.com%20Payments%20for%20SAP%20Commerce%20Cloud). This contains the installer recipes and connector extensions.
...
2.  In the Global Settings tab, set the environment to _Test_, so you can start testing payments. (You will need to change this to _Production_ when you're ready to go live.)
