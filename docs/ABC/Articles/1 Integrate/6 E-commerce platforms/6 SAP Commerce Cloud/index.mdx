...
<img maxWidth={350} src="/docs/Integrate/SAP/webhook–magento-2.png" title="Webhook Magento 2" withFullscreenPreview />
...
1.  <ExternalLink href="https://store.sap.com/dcp/en/product/display-0000059364_live_v1/Checkout.com%20Payments%20for%20SAP%20Commerce%20Cloud" target="_blank">Download the latest Checkout.com SAP Commerce Cloud Connector</ExternalLink>. This contains the installer recipes and connector extensions.
