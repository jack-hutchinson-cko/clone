...
2.  If you want to process all payments as 3D Secure payments, set Use 3D Secure to _True_.
3.  Select whether you want to Attempt non-3D Secure transactions. If you select _True_, any cards that do not support 3DS will go through without a 3DS check. If you select _False_, cards that do no support 3DS will be blocked.
