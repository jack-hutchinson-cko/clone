...
* Invoice generation
* [3D Secure 2.0](/risk-management/3-d-secure)
* Risk management
...
<img maxWidth={800} src="/docs/Integrate/channel_settings.png" title="Channel settings" withFullscreenPreview />
...
1.  <ExternalLink href="https://github.com/checkout/checkout-prestashop1.7-plugin" target="_blank">Download the plugin from GitHub</ExternalLink>.
2.  Unzip the folder.
...
6. Enter your secret key and public key. If you're testing, make sure you use the API keys from your sandbox Hub account, then select _Set Webhooks_ to automatically register your webhooks in [Checkout.com](http://checkout.com/) Hub.
...
If you're happy with the outcome of your testing and want to start taking payments right away, please <ExternalLink href="https://checkout.com/contact-sales" target="_blank">contact our Sales team</ExternalLink> in order to move to a live account.
