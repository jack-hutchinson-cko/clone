...
You can extend your configuration to [add more payment methods](/go-further-with-prestashop#Add_more_payment_methods), use [3D Secure payments](/go-further-with-prestashop#Enable_3D_Secure_payments), and more.
