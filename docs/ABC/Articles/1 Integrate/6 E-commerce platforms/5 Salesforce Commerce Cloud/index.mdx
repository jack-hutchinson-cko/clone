...
<img maxWidth={400} src="/docs/Integrate/Salesforce/sfcc-webhook.png" alt="SFCC Webhook" withFullscreenPreview />
...
1.  Download our <ExternalLink href="https://github.com/checkout/link_checkoutcom). This package includes the frontend cartridges for SFRA (`int_checkoutcom_sfra`) and SiteGenesis (`int_checkoutcom`), as well as the backend cartridge (`bm_checkoutcom`" target="_blank">installation package from GitHub</ExternalLink>, which is compatible with both SFRA and SiteGenesis.
2.  Upload the relevant <ExternalLink href="https://github.com/checkout/link_checkoutcom/tree/master/Cartridges" target="_blank">cartridges</ExternalLink> to your server, using a tool like UX Studio:
...
<img maxWidth={700} src="/docs/Integrate/Salesforce/Frame+2366.png" withFullscreenPreview />
...
If you're happy with the outcome of your testing and want to start taking payments right away, please <ExternalLink href="https://www.checkout.com/contact-sales" target="_blank">contact our Sales team</ExternalLink> in order to move to a live account.
