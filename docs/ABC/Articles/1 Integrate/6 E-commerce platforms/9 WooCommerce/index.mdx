...
1.  Log in to WordPress as an administrator.
2.  In the left menu, select _Plugins_.
3.  Find the Checkout.com plugin and select on _Settings_ below it.
...
9.  Select the *Card Settings* tab, then select _Save changes_. Do the same for the Order Settings. This will activate our default configuration.
