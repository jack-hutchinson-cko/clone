...
To get started with Apple Pay payments, you must first download your Certificate Signing Request from the <ExternalLink href="https://developer.apple.com/account/" >Hub sandbox](https://sandbox.checkout.com/) and upload it to the [Apple Development Center</ExternalLink>. You can find step-by-step instructions for this under _Settings > Apple Pay_ in the Hub sandbox.
...
1.  In the <ExternalLink href="https://sandbox.checkout.com/), select " >Hub sandbox</ExternalLink>_Payments_.
