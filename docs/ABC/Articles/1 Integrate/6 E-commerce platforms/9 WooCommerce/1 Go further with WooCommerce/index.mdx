...
To get started with Google Pay payments, you must first [register with Google Pay](https://services.google.com/fb/forms/googlepayAPIenable/) and select Checkout.com as your payment processor.
...
The Checkout.com WooCommerce plugin registers with payment events triggered by [WooCommerce Subscriptions](https://woocommerce.com/products/woocommerce-subscriptions/?quid=5e8af87e904d140455ce35c27943f7ce) to support the following actions:
