...
In order to start accepting an alternative payment method, we first need to enable it on your account. Please contact your customer success manager or our <ExternalLink href="https://checkout.com/contact-sales" target="_blank">Sales team</ExternalLink> to get started.
...
If you're located in the UAE or Saudi Arabia, please contact your Customer Success manager or our <ExternalLink href="https://www.checkout.com/contact-sales" target="_blank">Sales team</ExternalLink> to activate Apple Pay on your account.

To get started with Apple Pay payments, you must first download your Certificate Signing Request from the <ExternalLink href="https://developer.apple.com/account/" target="_blank">Hub sandbox](https://sandbox.checkout.com/) and upload it to the [Apple Development Center</ExternalLink>. You can find step-by-step instructions for this under _Settings > Apple Pay_ in the Hub sandbox.
...
7.  Enter your merchant identifier. You can find it in the <ExternalLink href="https://developer.apple.com/account/" target="_blank">Apple Development Center</ExternalLink>.
8.  Enter the absolute path to your merchant certificate and merchant certificate key.
9.  Select a button type and button theme. You can see what these will look like in the <ExternalLink href="https://applepaydemo.apple.com/" target="_blank">official Apple Pay demo</ExternalLink>.
...
If you're located in the UAE or Saudi Arabia, please contact your Customer Success manager or our <ExternalLink href="https://www.checkout.com/contact-sales" target="_blank">Sales team</ExternalLink> to activate Google Pay on your account.

To get started with Google Pay payments, you must first <ExternalLink href="https://services.google.com/fb/forms/googlepayAPIenable/" target="_blank">register with Google Pay</ExternalLink> and select Checkout.com as your payment processor.
...
1.  In the <ExternalLink href="https://sandbox.checkout.com/), select " target="_blank">Hub sandbox</ExternalLink>_Payments_.
...
<img maxWidth={700} src="/docs/Integrate/WooCommerce/woocommerce_order_details.png" withFullscreenPreview />
...
To be able to use this feature, you must be using WooCommerce Subscriptions to manage subscriptions within WooCommerce. See <ExternalLink href="https://docs.woocommerce.com/document/subscriptions/store-manager-guide/#section-1" target="_blank">WooCommerce Subscriptions Store Manager Guide</ExternalLink>.

</TipBox>

The Checkout.com WooCommerce plugin registers with payment events triggered by <ExternalLink href="https://woocommerce.com/products/woocommerce-subscriptions/?quid=5e8af87e904d140455ce35c27943f7ce" target="_blank">WooCommerce Subscriptions</ExternalLink> to support the following actions:
...
<img maxWidth={700} src="/docs/Integrate/WooCommerce/woocommerce_order_settings.png" withFullscreenPreview alt="WooCommerce order settings"/>
