...
7. Enter your Secret Key and Public Key. If you're testing, make sure you use the API keys from your sandbox Hub account, then select _Set Webhooks_ to automatically register your webhooks in [Checkout.com](https://checkout.com/) Hub.
