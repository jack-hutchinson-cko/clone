...
7. Enter your Secret Key and Public Key. If you're testing, make sure you use the API keys from your sandbox Hub account, then select *Set Webhooks* to automatically register your webhooks in [Checkout.com](http://checkout.com/) Hub.
