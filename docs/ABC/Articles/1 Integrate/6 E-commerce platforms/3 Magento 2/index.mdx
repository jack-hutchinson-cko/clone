...
6. Then go to Account Setting.
7. Enter your Secret Key and Public Key. If you're testing, make sure you use the API keys from your sandbox Hub account, then select *Set Webhooks* to automatically register your webhooks in [Checkout.com](https://checkout.com/) Hub.
