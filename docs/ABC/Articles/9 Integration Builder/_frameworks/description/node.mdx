...
To access everything in our Node SDK, install the `checkout-sdk-node` package into your codebase. We’re using <ExternalLink href="https://www.npmjs.com/package/frames-react" target="_blank">npm</ExternalLink> as our package manager in this example.
