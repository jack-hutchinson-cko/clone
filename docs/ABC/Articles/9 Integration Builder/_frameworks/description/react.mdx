...
To access everything in our React wrapper, install the `frames-react` package into your codebase. We’re using <ExternalLink href="https://www.npmjs.com/package/frames-react" target="_blank">npm</ExternalLink> as our package manager in this example.
