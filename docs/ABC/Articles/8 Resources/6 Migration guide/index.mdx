...
*   Your existing front-end solution (e.g., Frames, [Checkout.js](/archive/checkout-js), SDKs) can still be used to collect your customer's card information.
...
The [Checkout.js](/archive/checkout-js) solution no longer supports alternative payment methods. Instead, a direct integration with the Unified Payments API should be used to request payments using alternative payment methods.
