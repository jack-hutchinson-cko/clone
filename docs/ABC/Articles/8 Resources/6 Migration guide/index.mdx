...
*   Your existing front-end solution (e.g., Frames, [Checkout.js](https://docs.checkout.com/archive/checkout-js), SDKs) can still be used to collect your customer's card information.
...
The card charges endpoint is used to [request a payment](https://archive.docs.checkout.com/docs/authorize-a-payment).
...
The card charges endpoint is used to [request a payment](https://archive.docs.checkout.com/docs/authorize-a-payment) using a customer ID.
...
*   The card charges endpoint is used to [request a payment](https://archive.docs.checkout.com/docs/payment-with-full-card-details#api-payment-with-full-card-details). Full card details should be specified in the card object of the payment request.
*   A card ID is provided in the charge response, which can be used for subsequent payments with the same card information.

</TableCell>
<TableCell>

*   The unified payments endpoint is used to [request a payment](/integrate/full-card-details-api). A source type of `card` should be used.
*   A source ID is provided in the payment response, which can be used for subsequent payments with the same card information.
...
*   The local payment endpoint is used to [request a payment](https://archive.docs.checkout.com/docs/payment-with-full-card-details#api-payment-with-full-card-details) using the payment token.
...
The [Checkout.js](https://docs.checkout.com/archive/checkout-js) solution no longer supports alternative payment methods. Instead, a direct integration with the Unified Payments API should be used to request payments using alternative payment methods.
