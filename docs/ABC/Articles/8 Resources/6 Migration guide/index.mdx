...
*   Your existing front-end solution (e.g., Frames, <a href="https://docs.checkout.com/archive/checkout-js" target="_blank">Checkout.js</a>, SDKs) can still be used to collect your customer's card information.
...
*   The token charges endpoint is used to <a href="https://archive.docs.checkout.com/docs/authorize-a-payment" target="_blank">request a payment</a> using the card token from step 2.
...
The card charges endpoint is used to <a href="https://archive.docs.checkout.com/docs/authorize-a-payment" target="_blank">request a payment</a>.
...
The card charges endpoint is used to <a href="https://archive.docs.checkout.com/docs/authorize-a-payment" target="_blank">request a payment</a> using a customer ID.
...
*   The card charges endpoint is used to <a href="https://archive.docs.checkout.com/docs/payment-with-full-card-details#api-payment-with-full-card-details" target="_blank">request a payment</a>. Full card details should be specified in the card object of the payment request.
*   A card ID is provided in the charge response, which can be used for subsequent payments with the same card information.

</TableCell>
<TableCell>

*   The unified payments endpoint is used to <a href="/integrate/full-card-details-api" target="_blank">request a payment</a>. A source type of `card` should be used.
*   A source ID is provided in the payment response, which can be used for subsequent payments with the same card information.
...
*   The <a href="https://archive.docs.checkout.com/docs/process-alternative-payment-methods#section--span-class-step_hl-step-1-span-create-a-payment-token-" target="_blank">payment token endpoint</a> is used to create a payment token.
*   The local payment endpoint is used to <a href="https://archive.docs.checkout.com/docs/payment-with-full-card-details#api-payment-with-full-card-details" target="_blank">request a payment</a> using the payment token.
...
The <a href="https://docs.checkout.com/archive/checkout-js" target="_blank">Checkout.js</a> solution no longer supports alternative payment methods. Instead, a direct integration with the Unified Payments API should be used to request payments using alternative payment methods.
