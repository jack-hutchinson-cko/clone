...
<div class="card-deck row-cols-md-2">
 <ExternalLink href="/integrate/hosted-payments-page" style="text-decoration:none"><div class="card">
	<div class="card-body">
	  <h3 class="card-title">Hosted Payments Page</h3>
	  <p>Learn more about Hosted Payment Pages and how to set up your integration.</p>
	</div>
  </div></ExternalLink>
  <ExternalLink href="/integrate/frames" style="text-decoration:none"><div class="card">
	<div class="card-body">
