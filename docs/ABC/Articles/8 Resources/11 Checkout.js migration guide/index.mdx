...
You don’t have to worry about managing the session. When we redirect the customer back to your page, we provide a session ID (`cko-session-id`) or payment ID (`cko-payment-id`) as a query parameter in the URL, which you can pass into our <ExternalLink href="https://api-reference.checkout.com/#operation/getPaymentDetails" target="_blank">get payment details endpoint</ExternalLink> to get a full overview of the payment.
...
<div class="card-deck row-cols-md-2">
 <a href="/integrate/hosted-payments-page" style="text-decoration:none"><div class="card">
	<div class="card-body">
	  <h3 class="card-title">Hosted Payments Page</h3>
	  <p>Learn more about Hosted Payment Pages and how to set up your integration.</p>
	</div>
  </div></a>
  <a href="/integrate/frames" style="text-decoration:none"><div class="card">
	<div class="card-body">
