...
<img src="/docs/resources/ckojs_migration_hosted_payments_page.png" withFullscreenPreview />
...
You don’t have to worry about managing the session. When we redirect the customer back to your page, we provide a session ID (`cko-session-id`) or payment ID (`cko-payment-id`) as a query parameter in the URL, which you can pass into our [get payment details endpoint](https://api-reference.checkout.com/#operation/getPaymentDetails) to get a full overview of the payment.
...
<img src="/docs/resources/ckojs_migration_frames.png" withFullscreenPreview />
...
<div class="card-deck row-cols-md-2">
 <a href="https://docs.checkout.com/integrate/hosted-payments-page" style="text-decoration:none"><div class="card">
	<div class="card-body">
	  <h3 class="card-title">Hosted Payments Page</h3>
	  <p>Learn more about Hosted Payment Pages and how to set up your integration.</p>
	</div>
  </div></a>
  <a href="https://docs.checkout.com/integrate/frames" style="text-decoration:none"><div class="card">
	<div class="card-body">
	  <h3 class="card-title">Frames</h3>
	  <p>Learn more about Frames, and how to set up and customize your integration.</p>
	</div>
  </div></a>
</div>
```
