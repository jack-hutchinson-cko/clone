...
1.  In the API keys section, you can view your current public and secret key.
...
To add a new user, select _New user_, found in the User management section of Settings (see screenshot above).
