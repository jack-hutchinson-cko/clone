...
If you haven't got an account, sign up for a <ExternalLink href="https://www.checkout.com/get-test-account" target="_blank">test account</ExternalLink> now, or log in to your <ExternalLink href="https://sandbox.checkout.com/login" target="_blank">sandbox</ExternalLink> or <ExternalLink href="https://hub.checkout.com/login" target="_blank">live</ExternalLink>.

<TipBox variant="note">

This section of the docs is for the Hub version 2. If you are an existing merchant using the Classic API, you can access the Hub version 1 documentation <ExternalLink href="https://archive.docs.checkout.com/docs/getting-started" target="_blank">here</ExternalLink>.
...
<ContentPanel imgWidth={32} imgSrc="/docs/TheHub/TheHubAtGlance/6-hub-icon-settings.svg">
