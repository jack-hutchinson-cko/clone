...
<ContentPanel imgWidth={32} imgSrc="/docs/docs/TheHub/TheHubAtGlance/1-hub-icon-dashboard.svg">
...
<ContentPanel imgWidth={32} imgSrc="/docs/docs/TheHub/TheHubAtGlance/2-hub-icon-payments.svg">
...
<ContentPanel imgWidth={32} imgSrc="/docs/docs/TheHub/TheHubAtGlance/3-hub-icon-customers.svg">
...
<ContentPanel imgWidth={32} imgSrc="/docs/docs/TheHub/TheHubAtGlance/4-hub-icon-data-analysis.svg">
...
<ContentPanel imgWidth={32} imgSrc="/docs/docs/TheHub/TheHubAtGlance/5-hub-icon-disputes.svg">
...
<ContentPanel imgWidth={32} imgSrc="/docs/docs/TheHub/TheHubAtGlance/6-hub-icon-settings.svg">
