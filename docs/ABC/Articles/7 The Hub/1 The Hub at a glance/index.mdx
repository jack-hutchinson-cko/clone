...
If you haven't got an account, <ExternalLink href="https://hub.checkout.com/login" target="_blank">sign up for a test account](https://www.checkout.com/get-test-account) now, or log in to your [sandbox](https://sandbox.checkout.com/login) or [live</ExternalLink>.
