...
If payouts are enabled on your account, these will also be visible in your Payments screen. Just like with payments, you can select on them to view more details.
...
You can use filters to narrow down the list of payment actions displayed in your Payments screen.

### Search

To perform a search, start typing the first few letters or numbers of what you're looking for. The results displayed in the Payments screen are updated as you type.
...
1.  In the Payments screen, select _Create payment_ in the top right.
...
7.  Select _Create payment_ to confirm. The new payment is added to the Payments screen.
...
1.  In the Payments screen, select a payment. The payment details pane opens on the right.
2.  Select an action.
3.  If you want to perform a partial capture or refund, enter the amount of your choice.
4.  Select the confirmation button.
5.  Refresh the Payments screen. You will see your action in the list.
