...
4.  Attach the relevant evidence, then:
    *   If you've finished, select _Submit evidence_. The dispute has been answered and its status changes to `EVIDENCE UNDER REVIEW`. It will no longer appear in the Unanswered tab anymore, only in the All disputes tab.
