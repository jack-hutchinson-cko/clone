...
1.  In the Reports screen, select _New report_ in the appropriate section.
...
3.  Select _Generate report_. Reports containing a lot of data may take a while to generate, so feel free to do other things while you wait. Once generated, the report is added to the Reports screen where you can download it at any time by selecting _CSV_. Note that we only store up to 5 reports per type.
