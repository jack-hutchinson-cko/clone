...
2.  In the Webhooks section, select _New webhook_.
...
1.  Go to _Settings > Channels_.
2.  In the Webhooks section, select a webhook. A pop-up opens.
3.  From here, you can:
    *   edit your webhook: select _Edit_, make changes to your webhook, and apply them by selecting _Save changes_.
    *   disable your webhook: select the _Live_ toggle. It switches to Disabled. To re-enable it later, simply select the toggle again.
