<IBuilderDescriptionCard title="Include our script tag in your project" tab="payment-form.html" lines={[8, 8]}>
...
<IBuilderDescriptionCard title="Create the form" tab="payment-form.html" lines={[15, 64]}>
...
<IBuilderDescriptionCard title="Initialize Frames" tab="app.js" lines={[6, 8]}>
