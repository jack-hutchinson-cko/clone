<IBuilderDescriptionCard title="Set up Frames events" tab="app.js" lines={[25, 29]}>
...
<IBuilderDescriptionCard title="Handle form submission" tab="app.js" lines={[168, 172]}>
...
<IBuilderDescriptionCard title="Listen for card tokenization" tab="app.js" lines={[174, 185]}>
