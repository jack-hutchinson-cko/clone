...
To access everything in our React wrapper, install the `frames-react` package into your codebase. We’re using [npm](https://www.npmjs.com/package/frames-react) as our package manager in this example.

`npm install frames-react`

</IBuilderDescriptionCard>

<IBuilderDescriptionCard title="Import the React components" tab="Form.jsx" lines={[1, 1]}>
