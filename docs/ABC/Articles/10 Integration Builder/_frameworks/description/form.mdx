<IBuilderDescriptionCard title="Create a component for the payment form" tab="Form.jsx" lines={[4, 116]}>
...
<IBuilderDescriptionCard title="Handle Form states" tab="App.js" lines={[11, 26]}>
...
<IBuilderDescriptionCard title="Pass props into the Frames component" tab="Form.jsx" lines={[66, 87]}>

Because the `frames-react` components are iframes, there are specific ways to interact with them. That’s why we use the `Frames` component’s several built-in props to handle Frames custom events. [Read more about available props](https://github.com/checkout/frames-react#the-props).
...
<IBuilderDescriptionCard title="Handle card submit" tab="Form.jsx" lines={[108, 110]}>
