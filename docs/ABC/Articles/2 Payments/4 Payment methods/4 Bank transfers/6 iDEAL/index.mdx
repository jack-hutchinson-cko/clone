...
iDEAL supports both partial and full refunds. You can refund a payment through the <ExternalLink href="https://hub.checkout.com/v2" target="_blank">hub</ExternalLink> or using the [refund API](/payments/manage-payments/refund-a-payment).
