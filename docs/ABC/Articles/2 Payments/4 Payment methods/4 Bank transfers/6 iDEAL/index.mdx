...
1.  [Request a payment](/payments/payment-methods/bank-transfers/ideal#Request_a_payment)
2.  [Redirect the customer](/payments/payment-methods/bank-transfers/ideal#Redirect_the_customer)
