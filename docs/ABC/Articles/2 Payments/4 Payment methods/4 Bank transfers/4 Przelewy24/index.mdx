...
1.  [Request a payment](/payments/payment-methods/bank-transfers/przelewy24#Request_a_payment)
2.  [Redirect the customer](/payments/payment-methods/bank-transfers/przelewy24#Redirect_the_customer)
