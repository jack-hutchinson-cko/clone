...
Przelewy24 supports both partial and full refunds. You can refund a payment through the [Hub](https://hub.checkout.com/v2) or using the [refund API](/payments/manage-payments/refund-a-payment).
...
2.  Leave the Bank name or BIC field blank and select _Next_.
3.  Leave the Account Number and PIN fields blank and then select _Login_.
4.  Leave the TAN field blank and select _Make Payment_.
