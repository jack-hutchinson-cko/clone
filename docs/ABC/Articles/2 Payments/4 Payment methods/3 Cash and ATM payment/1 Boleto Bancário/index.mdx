...
To get the components necessary to render the ticket, use the ['get payment details' endpoint](/docs/boleto-bancario#section-get-details-about-a-payment) below. This will return a `ticket` object which contains the components to display the ticket.
