...
Shoppers can now make Fawry payments via the myFawry app <ExternalLink href="https://apps.apple.com/de/app/myfawry/id1462911630?l=en" target="_blank">App Store</ExternalLink> and <ExternalLink href="https://play.google.com/store/apps/details?id=com.fawry.myfawry&hl=en&gl=US" target="_blank">Google Play</ExternalLink>, rather than having to take their payment reference to a shop or ATM, meaning a better payment experience for both you and your customers.
...
Fawry supports both partial (see note below for details) and full refunds. You can refund a payment through the <ExternalLink href="https://hub.checkout.com/v2" target="_blank">hub</ExternalLink> or by using the <ExternalLink href="/payments/manage-payments/refund-a-payment" target="_blank">refund API</ExternalLink>.
