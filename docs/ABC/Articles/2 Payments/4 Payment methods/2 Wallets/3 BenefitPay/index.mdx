...
You can find the full list, as well as complete request and response examples, in our <ExternalLink href="https://api-reference.checkout.com/#tag/Payments/paths/~1payments/post" target="_blank">API reference</ExternalLink>.
