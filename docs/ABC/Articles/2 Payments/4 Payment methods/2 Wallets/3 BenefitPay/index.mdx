...
1.  [Request a BenefitPay payment](s/payments/payment-methods/wallets/benefitpay#Request_a_payment)
2.  [Display the QR code to the customer](s/payments/payment-methods/wallets/benefitpay#Display_the_QR_code)
...
If you opt for a mobile payment, the customer can pay with the BenefitPay mobile app by either [scanning the QR code](s/payments/payment-methods/wallets/benefitpay#Display_the_QR_code) or logging in to pay with the card attached to their account.
