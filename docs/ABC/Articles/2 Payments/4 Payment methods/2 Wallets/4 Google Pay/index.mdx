...
Before going live, you are required to register with <ExternalLink href="https://services.google.com/fb/forms/googlepayAPIenable/" target="_blank">Google Pay</ExternalLink> and select Checkout.com as your payment processor. You will also need to <ExternalLink href="https://payments.developers.google.com/signup" target="_blank">whitelist your domain here</ExternalLink>. Note that you must be logged in as a Google Developer to do this. If not, you will be redirected to Google Pay's support page.
