...
Alternatively, if you want to decrypt the Google Pay token yourself and process a payment, follow our [pay with a pre-decrypted token guide](/payments/payment-methods/wallets/google-pay/pay-with-a-pre-decrypted-google-pay-token).
