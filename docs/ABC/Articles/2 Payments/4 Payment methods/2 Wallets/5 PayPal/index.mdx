...
1.  [Request a PayPal payment](/payments/payment-methods/wallets/paypal#Request_a_payment)
2.  [Redirect the customer](/payments/payment-methods/wallets/paypal#Redirect_the_customer)
