...
1.  In your Apple Developer account, go to the [_Add Merchant IDs_ section](https://developer.apple.com/account/resources/identifiers/add/merchant), select **Merchant IDs** and select _Continue_.
