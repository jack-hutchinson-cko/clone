...
1.  In your Apple Developer account, go to the <ExternalLink href="https://developer.apple.com/account/resources/identifiers/add/merchant" target="_blank">_Add Merchant IDs_ section</ExternalLink>, select _Merchant IDs_ and select _Continue_.
...
1.  Log in to your <ExternalLink href="https://hub.checkout.com/v2" target="_blank">Hub account</ExternalLink>, go to _Settings > Apple Pay_ and select _New Certificate_.
...
4.  Log in to your Apple Developer account, go to the <ExternalLink href="https://developer.apple.com/account/resources/identifiers/list/merchant" target="_blank">_Merchant IDs list_ section</ExternalLink>, and select the merchant ID you created in step 1.
...
1.  Log in to your Apple Developer account, go to the <ExternalLink href="https://developer.apple.com/account/resources/identifiers/list/merchant" target="_blank">_Merchant IDs list_ section</ExternalLink> and select the merchant ID you created in step 1.
...
3.  Sign in to your Apple Developer account, go to the <ExternalLink href="https://developer.apple.com/account/resources/identifiers/list/merchant" target="_blank">_Merchant IDs list_ section</ExternalLink> and select the merchant ID you created in step 1.
...
*   <ExternalLink href="https://developer.apple.com/documentation/passkit/apple_pay" target="_blank">Apple Pay Mobile</ExternalLink>.
...
<img src="/docs/Payments/apple_pay_flow.png" alt="Apple pay flow" withFullscreenPreview />
