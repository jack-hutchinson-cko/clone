...
3.  Sign in to your Apple Developer account, go to the [_Merchant IDs list_ section](https://developer.apple.com/account/resources/identifiers/list/merchant) and select the merchant ID you created in step 1.
