...
If accepting [Mada cards](/payments/payment-methods/cards/mada) via Apple Pay, do not include the supportsEMV value in the <ExternalLink href="https://developer.apple.com/documentation/apple_pay_on_the_web/applepaypaymentrequest/1916123-merchantcapabilities" target="_blank">`merchantCapabilities`</ExternalLink>` array, otherwise it may cause a failure with a `20030` format error.
