...
If accepting [Mada cards](/payments/payment-methods/cards/mada) via Apple Pay, do not include the supportsEMV value in the `[merchantCapabilities](https://developer.apple.com/documentation/apple_pay_on_the_web/applepaypaymentrequest/1916123-merchantcapabilities)` array, otherwise it may cause a failure with a `20030` format error.
