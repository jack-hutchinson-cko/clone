...
1.  [Request a QPay payment](/payments/payment-methods/cards/qpay#Request_a_payment)
2.  [Redirect the customer](/payments/payment-methods/cards/qpay#Redirect_the_customer)
