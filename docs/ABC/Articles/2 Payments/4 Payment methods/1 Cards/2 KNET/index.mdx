...
KNET supports full, partial and multiple partial refunds. Refund a payment through the <ExternalLink href="https://hub.checkout.com/v2" target="_blank">hub</ExternalLink> or by using our [refund API](/payments/manage-payments/refund-a-payment").
