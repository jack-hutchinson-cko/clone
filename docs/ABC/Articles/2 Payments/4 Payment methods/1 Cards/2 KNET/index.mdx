...
KNET supports full, partial and multiple partial refunds. Refund a payment through the [Hub](https://hub.checkout.com/v2) or by using our [refund API](/payments/manage-payments/refund-a-payment).
