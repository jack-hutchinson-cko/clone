...
Bancontact supports both partial and full refunds. You can refund a payment through the <ExternalLink href="https://hub.checkout.com/v2" target="_blank">hub</ExternalLink> or by using the <ExternalLink href="/payments/manage-payments/refund-a-payment" target="_blank">refund API</ExternalLink>.
