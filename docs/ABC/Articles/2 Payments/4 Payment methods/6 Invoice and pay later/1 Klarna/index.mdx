...
Use the valid secret key of your Checkout.com account. You can find this in the <ExternalLink href="https://hub.checkout.com/v2" target="_blank">Hub</ExternalLink>.
...
This object is passed directly to Klarna as order\_lines. See <ExternalLink href="https://developers.klarna.com/api/" target="_blank">Klarna's documentation</ExternalLink> for more information.
...
This object is passed directly to Klarna as `order_lines`. See <ExternalLink href="https://developers.klarna.com/api/" target="_blank">Klarna's documentation</ExternalLink> for more information.
...
<tabs>
<tab title="Capture accepted" active>
...
<tab title="Invalid data was sent">
...
Klarna supports both partial and full refunds. You can refund a payment through the <ExternalLink href="https://hub.checkout.com/v2" target="_blank">hub</ExternalLink> or using the [refund API](/payments/manage-payments/refund-a-payment).
...
<tabs>
<tab title="Void accepted" active>
...
When testing, you may be asked to verify your details. If so, follow <ExternalLink href="https://docs.klarna.com/resources/test-environment" target="_blank">Klarna’s testing guide</ExternalLink>.
