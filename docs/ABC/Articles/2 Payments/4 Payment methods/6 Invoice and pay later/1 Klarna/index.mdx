...
Klarna supports both partial and full refunds. You can refund a payment through the [Hub](https://hub.checkout.com/v2) or using the [refund API](/payments/manage-payments/refund-a-payment).
...
When testing, you may be asked to verify your details. If so, follow [Klarna’s testing guide](https://docs.klarna.com/resources/test-environment).
