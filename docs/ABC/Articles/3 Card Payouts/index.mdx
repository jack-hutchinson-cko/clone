...
The table below describes the minimum recommended fields for making a payout. See our <ExternalLink href="https://api-reference.checkout.com/#tag/Payments) for the full specification." target="_blank">API reference</ExternalLink>.
