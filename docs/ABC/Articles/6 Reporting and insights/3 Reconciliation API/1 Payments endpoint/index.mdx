...
If you're not familiar with creating API requests, you might want to take a look at our [Postman guide](https://docs.checkout.com/reporting-and-insights/reconciliation-api/postman-guide).
...
You can also [limit results](https://docs.checkout.com/reporting-and-insights/reconciliation-api/payments-endpoint#Paymentsendpoint-limitresults).
...
By default, the payments endpoint returns up to 200 payments per page of results. You can [change this limit](https://docs.checkout.com/reporting-and-insights/reconciliation-api/payments-endpoint#Paymentsendpoint-limitresults) if you'd like.
...
This link lets you move to the next page of results. Results are paginated at a payment level. By default, a page contains 200 results — though you can [change this limit](https://docs.checkout.com/reporting-and-insights/reconciliation-api/payments-endpoint#Paymentsendpoint-limitresults) if you'd like.
...
<img src="/docs/Reporting_and_insights/Payments endpoint/payment_card_attributes.png" withFullscreenPreview />
...
<img maxWidth={380} src="/docs/Reporting_and_insights/Payments endpoint/actions.png" withFullscreenPreview />

#### 3. Breakdown

This section provides details of the associated amounts to an action in both the processing and the payout currencies.

<img maxWidth={380} src="/docs/Reporting_and_insights/Payments endpoint/breakdown.png" withFullscreenPreview />
