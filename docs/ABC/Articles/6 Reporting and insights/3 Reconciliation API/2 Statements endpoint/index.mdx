...
No payments before February 7th, 2019 at 00.00.00 UTC will appear using the statements endpoint. To view payments before this time, please use the <a href="https://archive.docs.checkout.com/docs/reconciliation-api" target="_blank">Classic API's transactions endpoint</a>.
