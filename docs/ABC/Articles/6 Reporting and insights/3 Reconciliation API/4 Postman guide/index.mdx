...
- Grab your secret key. You can find it in the [Hub](https://hub.checkout.com/login) under _Settings > Channels._
...
In the _Headers_ tab, enter `Authorization` in the _Key_ column. In the _Value_ column, add your secret key. You can find your secret key in the _Settings > Channels_ section of the [Hub](https://hub.checkout.com/). Next, enter `Content-Type` in the _Key_ column and `application/json` in the _Value_ column.
...
In the Headers tab, enter `Authorization` in the _Key_ column. In the _Value_ column, add your secret key. You can find your secret key in the _Settings > Channels_ section of the [Hub](https://hub.checkout.com/login).
