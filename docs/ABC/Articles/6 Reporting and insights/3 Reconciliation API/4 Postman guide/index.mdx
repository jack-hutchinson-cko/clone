...
- Download and install the Postman application. You can find it here: <ExternalLink href="https://www.getpostman.com" target="_blank">https://www.getpostman.com</ExternalLink>.
- Grab your secret key. You can find it in the <ExternalLink href="https://hub.checkout.com/login" target="_blank">Hub</ExternalLink> under _Settings > Channels._
...
<img maxWidth={600} src="/docs/Reporting_and_insights/Postman guide/postman-guide1.png" withFullscreenPreview />

#### Step 2: Set your parameters

To use this endpoint, you need to specify one of the 3 parameters below:

- date / time in <ExternalLink href="https://www.w3.org/TR/NOTE-datetime) (`from` and `to`" target="_blank">ISO format</ExternalLink>
...
<img maxWidth={660} src="/docs/Reporting_and_insights/Postman guide/postman-guide2.png" withFullscreenPreview />
...
In the _Headers_ tab, enter `Authorization` in the _Key_ column. In the _Value_ column, add your secret key. You can find your secret key in the _Settings > Channels_ section of the <ExternalLink href="https://hub.checkout.com" target="_blank">Hub</ExternalLink>. Next, enter `Content-Type` in the _Key_ column and `application/json` in the _Value_ column.

<img maxWidth={650} src="/docs/Reporting_and_insights/Postman guide/postman-guide3.png" withFullscreenPreview />
...
<img maxWidth={240} src="/docs/Reporting_and_insights/Postman guide/postman-send.png" withFullscreenPreview />
...
In the Headers tab, enter `Authorization` in the _Key_ column. In the _Value_ column, add your secret key. You can find your secret key in the _Settings > Channels_ section of the <ExternalLink href="https://hub.checkout.com/login" target="_blank">Hub</ExternalLink>.
...
<img maxWidth={240} src="/docs/Reporting_and_insights/Postman guide/postman-send-1.png" withFullscreenPreview />
