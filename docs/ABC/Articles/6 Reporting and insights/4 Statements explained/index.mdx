...
If your business is registered in the United States, your fees have different names. Learn more about the [terminology used for US merchants](#US_fee_terminology).
...
The header of the VAT Invoice shows some additional information to that explained in [the header](#The_header).
