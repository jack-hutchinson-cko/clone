...
Any organization involved with the processing, transmission, or storage of card data must comply with the <ExternalLink href="https://www.pcisecuritystandards.org/security_standards" target="_blank">Payment Card Industry Data Security Standards</ExternalLink> (PCI DSS).
...
*   Review and validate your PCI compliance once a year. Most can do this with a <ExternalLink href="https://www.pcisecuritystandards.org/document_library?category=saqs#results" target="_blank">Self-Assessment Questionnaire</ExternalLink> (SAQ), which is provided by the <ExternalLink href="https://www.pcisecuritystandards.org/" target="_blank">PCI Security Standards Council</ExternalLink>.
...
*   On-site assessment using the PCI DSS requirements and Security Assessment Procedures conducted by an approved <ExternalLink href="https://www.pcisecuritystandards.org/assessors_and_solutions/qualified_security_assessors" target="_blank">Security Assessor</ExternalLink> (QSA) or a qualified <ExternalLink href="https://www.pcisecuritystandards.org/program_training_and_qualification/internal_security_assessor_certification) (ISA" target="_blank">QualityInternal Security Assessor</ExternalLink>.
*   Quarterly network scan by an <ExternalLink href="https://www.pcisecuritystandards.org/assessors_and_solutions/approved_scanning_vendors" target="_blank">Approved Scan Vendor</ExternalLink> (ASV).
...
*   Quarterly network scan by an <ExternalLink href="https://www.pcisecuritystandards.org/assessors_and_solutions/approved_scanning_vendors" target="_blank">Approved Scan Vendor</ExternalLink> (ASV) where applicable.
...
<ExternalLink href="https://docs.checkout.com/archive/checkout-js" target="_blank">Checkout.js</ExternalLink> or [Frames](/integrate/frames)
