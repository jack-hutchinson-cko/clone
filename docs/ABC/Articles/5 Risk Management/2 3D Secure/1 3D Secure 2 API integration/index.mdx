...
If you want to test 3DS authentication flows and transaction statuses in the sandbox environment, [use our test cards](/testing/3-d-secure-testing).
...
<img src="/docs/Risk Management/3ds2_challenge.png" alt="3d secure 2 challenge" maxWidth={453} withFullscreenPreview />
...
For the full specification, as well as complete request and response examples, see our <ExternalLink href="https://api-reference.checkout.com" target="_blank">API reference</ExternalLink>.
...
<img src="/docs/Risk Management/Non-3DS-authorization.png" alt="Non-3DS authorization" withFullscreenPreview />
...
<img src="/docs/Risk Management/Non-3DS-authorization-with-soft-decline.png" alt="Non-3DS authorization with soft decline" withFullscreenPreview />
