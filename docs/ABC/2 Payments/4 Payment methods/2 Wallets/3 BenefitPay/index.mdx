...
You can find the full list, as well as complete request and response examples, in our [API reference](https://api-reference.checkout.com/#tag/Payments/paths/~1payments/post).
...
You can use one of the following test cards in your sandbox environment. See our [testing guide](https://docs.checkout.com/testing) for more information.
