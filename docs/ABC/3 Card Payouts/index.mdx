...
- a [token](/card-payouts#CardPayouts-token),
- a [payment instrument](/card-payouts#CardPayouts-paymentinstrument), or 
- the [full card details](/card-payouts#CardPayouts-carddetails).
