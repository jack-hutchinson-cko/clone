...
They are generated automatically based on your payout frequencies, and you can find them in the Statements screen in the <ExternalLink href="https://hub.checkout.com" target="_blank">Hub</ExternalLink>.
...
The _Statements_ screen in the <ExternalLink href="https://hub.checkout.com" target="_blank">Hub</ExternalLink> allows you to view your current statement and download all previous ones.
...
We will keep trying to send to that endpoint for 7 days, after which you will be unsubscribed from that event type. To remain subscribed, update your webhook settings in the <ExternalLink href="https://hub.checkout.com" target="_blank">Hub</ExternalLink> under **Settings > Channels**. You will continue to receive webhook notifications for other events that are being processed successfully.
