...
For plugin versions 4.X or later, you need to set the following URLs in your [Hub](https://sandbox.checkout.com/login) account (replacing example.com with your site’s URL):
