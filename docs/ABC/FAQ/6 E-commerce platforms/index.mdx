...
Also, make sure that you've [deactivated/deleted any previous versions of the plugin](#Check_you_have_no_previous_version_of_the_plugin) you may have installed.
