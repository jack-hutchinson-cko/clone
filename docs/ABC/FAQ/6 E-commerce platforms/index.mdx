...
For plugin versions 4.X or later, you need to set the following URLs in your <ExternalLink href="https://sandbox.checkout.com/login) account (replacing example.com with your site’s URL" target="_blank">Hub</ExternalLink>:
...
You need plugin version 4.1.12 or later for this functionality, so make sure you have the latest version of our plugin. This can be downloaded from the <ExternalLink href="https://github.com/checkout/checkout-woocommerce-plugin" target="_blank">WordPress Plugin Directory](https://wordpress.org/plugins/checkout-com-unified-payments-api/#developers) or as a .zip file from [GitHub</ExternalLink>.
