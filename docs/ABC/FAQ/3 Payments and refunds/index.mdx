...
You can issue a refund (either full or partial) through the <ExternalLink href="https://hub.checkout.com/login" target="_blank">Hub</ExternalLink>, or by calling the [refund endpoint](/payments/manage-payments/refund-a-payment) by <ExternalLink href="https://docs.ckotech.co/the-hub/manage-payments#Managepayments-Capture,void,orrefundapayment">following these steps</ExternalLink>.
