...
import { BreadCrumbsItems, DocsPathItem } from 'src/types/content';
import { NavTreeElementWithFilePatch } from 'src/types/navTree';
import { clientSettings } from 'src/constants/clientSettings';
import { getAnchorUrl } from 'src/lib/url';
import {
