...
With external links, target="_blank" is the default behavour to open in a new tab.

## Example

Internal Links: [International](/payments/payment-methods/cards)
External Links: <a href="https://archive.docs.checkout.com/docs/reconciliation-api" >Classic API's transactions endpoint</a>
